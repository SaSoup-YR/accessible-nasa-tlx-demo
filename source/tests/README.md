...
Current checkpoint: **47 tests pass across ten files.**
...
- **conductor-component.test.ts** — researcher/participant separation, locked defaults, participant-link generation, configuration/result file distinction and conductor error focus.
...
- **study-component.test.ts** — configured participant-code gate, locked prepared support, configured-task spoken summary, full completion saving, score-display policy and host-event emission.
