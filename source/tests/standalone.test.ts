...
const standalonePath = new URL('../demo/accessible-nasa-tlx-v0.5.html', import.meta.url);

describe('self-contained Version 0.5 participant demonstration', () => {
  ...
  it('boots the compiled component and renders the participant introduction', async () => {
    ...
    const dom = new JSDOM(html, {
      ...
      url: 'file:///accessible-nasa-tlx-v0.5.html',
    });
