import{a as s,t as h,i as g,n as m,e as u,o as y,q as b,g as f,u as _,A as c,k as n,w as v,x as w}from"./study-z5_sWaHR.js";var T=Object.defineProperty,A=Object.getOwnPropertyDescriptor,a=(e,r,o,i)=>{for(var l=i>1?void 0:i?A(r,o):r,d=e.length-1,p;d>=0;d--)(p=e[d])&&(l=(i?p(r,o,l):p(l))||l);return i&&l&&T(r,o,l),l};function S(e){const r=Array.isArray(e)?e:[e];return r.length>0&&r.some(o=>{if(!o||typeof o!="object")return!1;const i=o;return"study"in i&&"responses"in i&&"result"in i})}function $(e){return["<style>","  #accessible-nasa-tlx-recorded-summary {","    display: none;","    color: #172235;","    font-family: Arial, Helvetica, sans-serif;","    line-height: 1.5;","  }",'  #accessible-nasa-tlx-recorded-summary[data-recorded="1"] { display: block; }','  #accessible-nasa-tlx-recorded-summary[data-recorded="1"] + #accessible-nasa-tlx-live-question { display: none; }',"  #accessible-nasa-tlx-recorded-summary h2,","  #accessible-nasa-tlx-recorded-summary h3 { color: #173f63; }","  #accessible-nasa-tlx-recorded-summary table {","    width: 100%;","    border-collapse: collapse;","    margin: 0 0 1.25rem;","  }","  #accessible-nasa-tlx-recorded-summary th,","  #accessible-nasa-tlx-recorded-summary td {","    border: 1px solid #9fb2c3;","    padding: 0.5rem;","    text-align: left;","    vertical-align: top;","  }","  #accessible-nasa-tlx-recorded-summary th { background: #edf4f8; }","  #accessible-nasa-tlx-recorded-summary .antlx-long-value {","    overflow-wrap: anywhere;","    white-space: pre-wrap;","  }","</style>","<section",'  id="accessible-nasa-tlx-recorded-summary"','  data-recorded="${e://Field/__js_ANTLX_ACCEPTED}"','  aria-labelledby="accessible-nasa-tlx-recorded-summary-heading"',">",'  <h2 id="accessible-nasa-tlx-recorded-summary-heading">Accessible NASA-TLX recorded response</h2>',"  <p>This read-only summary is generated from the values saved in this Qualtrics response.</p>","  <table>","    <caption>Submission details</caption>","    <tbody>",'      <tr><th scope="row">Participant code</th><td>${e://Field/__js_ANTLX_PARTICIPANT_CODE}</td></tr>','      <tr><th scope="row">Study ID</th><td>${e://Field/__js_ANTLX_STUDY_ID}</td></tr>','      <tr><th scope="row">Submission ID</th><td class="antlx-long-value">${e://Field/__js_ANTLX_SUBMISSION_ID}</td></tr>','      <tr><th scope="row">Started</th><td>${e://Field/__js_ANTLX_STARTED_AT}</td></tr>','      <tr><th scope="row">Completed</th><td>${e://Field/__js_ANTLX_COMPLETED_AT}</td></tr>','      <tr><th scope="row">Weighted workload score</th><td>${e://Field/__js_ANTLX_WEIGHTED_SCORE}/100</td></tr>',"    </tbody>","  </table>","  <h3>Ratings and weights</h3>","  <table>",'    <thead><tr><th scope="col">Dimension</th><th scope="col">Rating (0–100)</th><th scope="col">Weight (0–5)</th></tr></thead>',"    <tbody>",'      <tr><th scope="row">Mental Demand</th><td>${e://Field/__js_ANTLX_RATING_MENTAL}</td><td>${e://Field/__js_ANTLX_WEIGHT_MENTAL}</td></tr>','      <tr><th scope="row">Physical Demand</th><td>${e://Field/__js_ANTLX_RATING_PHYSICAL}</td><td>${e://Field/__js_ANTLX_WEIGHT_PHYSICAL}</td></tr>','      <tr><th scope="row">Temporal Demand</th><td>${e://Field/__js_ANTLX_RATING_TEMPORAL}</td><td>${e://Field/__js_ANTLX_WEIGHT_TEMPORAL}</td></tr>','      <tr><th scope="row">Performance</th><td>${e://Field/__js_ANTLX_RATING_PERFORMANCE}</td><td>${e://Field/__js_ANTLX_WEIGHT_PERFORMANCE}</td></tr>','      <tr><th scope="row">Effort</th><td>${e://Field/__js_ANTLX_RATING_EFFORT}</td><td>${e://Field/__js_ANTLX_WEIGHT_EFFORT}</td></tr>','      <tr><th scope="row">Frustration</th><td>${e://Field/__js_ANTLX_RATING_FRUSTRATION}</td><td>${e://Field/__js_ANTLX_WEIGHT_FRUSTRATION}</td></tr>',"    </tbody>","  </table>","  <h3>Pairwise comparisons</h3>",'  <p class="antlx-long-value">${e://Field/__js_ANTLX_PAIR_CHOICES_JSON}</p>',"  <h3>Accessibility-support record</h3>","  <table>","    <tbody>",'      <tr><th scope="row">Simpler explanations at submission</th><td>${e://Field/__js_ANTLX_FINAL_SIMPLE_LANGUAGE}</td></tr>','      <tr><th scope="row">Answer presentation at submission</th><td>${e://Field/__js_ANTLX_FINAL_ANSWER_MODE}</td></tr>','      <tr><th scope="row">Large text at submission</th><td>${e://Field/__js_ANTLX_FINAL_LARGE_TEXT}</td></tr>','      <tr><th scope="row">Automatic audio at submission</th><td>${e://Field/__js_ANTLX_FINAL_AUDIO}</td></tr>','      <tr><th scope="row">Recovery at submission</th><td>${e://Field/__js_ANTLX_FINAL_RECOVERY}</td></tr>','      <tr><th scope="row">Read aloud used</th><td>${e://Field/__js_ANTLX_READ_ALOUD_USED}</td></tr>','      <tr><th scope="row">Gaze used</th><td>${e://Field/__js_ANTLX_GAZE_USED}</td></tr>','      <tr><th scope="row">Support changes</th><td>${e://Field/__js_ANTLX_SUPPORT_CHANGE_COUNT}</td></tr>',"    </tbody>","  </table>",'  <p><strong>Rating input routes:</strong> <span class="antlx-long-value">${e://Field/__js_ANTLX_RATING_ROUTES_JSON}</span></p>','  <p><strong>Pair input routes:</strong> <span class="antlx-long-value">${e://Field/__js_ANTLX_PAIR_ROUTES_JSON}</span></p>',"  <p>The CSV or JSON export remains the lossless research record. This section is a readable response/PDF summary.</p>","</section>",'<div id="accessible-nasa-tlx-live-question">',"  <iframe",'    id="accessible-nasa-tlx-frame"',`    src="${e.replace(/&/g,"&amp;").replace(/"/g,"&quot;")}"`,'    title="Accessible NASA Task Load Index participant questionnaire"','    allow="camera; microphone"','    style="width:100%;min-height:1200px;border:0"',"  ></iframe>",'  <p id="accessible-nasa-tlx-collection-status" role="status" aria-live="polite"></p>',"</div>"].join(`
`)}let t=class extends g{constructor(){super(...arguments),this.studyId="",this.studyTitle="",this.taskLabel="",this.showScoreToParticipant=!1,this.showSimpleLanguage=!1,this.answerMode="standard",this.largeText=!1,this.audioGuidance=!1,this.recoveryEnabled=!0,this.participantAdjustmentPolicy="participant-choice",this.voiceInputAvailable=!0,this.gazeInputAvailable=!1,this.collectionMode="local",this.qualtricsSurveyUrl="",this.generatedConfig=null,this.participantUrl="",this.message="",this.errorMessage="",this.completedResults=[],this.generateParticipantLink=()=>{this.errorMessage="";try{const e=m({studyId:this.studyId,studyTitle:this.studyTitle,taskLabel:this.taskLabel,showScoreToParticipant:this.showScoreToParticipant,support:this.currentSupportConfig(),collection:this.currentCollectionConfig()});this.useConfiguration(e),this.message="Participant link and configuration generated."}catch(e){this.showError(e instanceof Error?e.message:"The study configuration could not be generated.")}},this.copyParticipantLink=async()=>{if(this.participantUrl)try{await navigator.clipboard.writeText(this.participantUrl),this.message="Participant link copied."}catch{this.message="Automatic copy was unavailable. Select and copy the link from the text box."}},this.downloadConfiguration=()=>{this.generatedConfig&&u(`${this.generatedConfig.studyId}-${this.generatedConfig.configId}.json`,JSON.stringify(this.generatedConfig,null,2),"application/json")},this.importConfiguration=async e=>{const r=e.currentTarget,o=r.files?.[0];if(o){this.errorMessage="";try{const i=JSON.parse(await o.text());if(!y(i))throw S(i)?new Error("This is a completed result file, not a study configuration. Import the JSON downloaded from Configuration ready."):new Error("This is not a valid Version 0.7 study configuration.");this.useConfiguration(i),this.message="Configuration imported and participant link regenerated."}catch(i){this.showError(i instanceof Error?i.message:"The configuration file could not be read.")}finally{r.value=""}}},this.refreshResults=()=>{this.completedResults=b()},this.exportResultsJson=()=>{this.completedResults.length&&u(`accessible-nasa-tlx-results-${new Date().toISOString().slice(0,10)}.json`,JSON.stringify(this.completedResults,null,2),"application/json")},this.exportResultsCsv=()=>{this.completedResults.length&&u(`accessible-nasa-tlx-results-${new Date().toISOString().slice(0,10)}.csv`,`\uFEFF${f(this.completedResults)}`,"text/csv")},this.eraseResults=()=>{window.confirm("Erase every completed NASA-TLX record stored by this site in this browser? Confirm only after checking the exported files.")&&(_(),this.refreshResults(),this.message="Local completed records erased.")}}connectedCallback(){super.connectedCallback(),this.refreshResults(),window.addEventListener("storage",this.refreshResults)}disconnectedCallback(){window.removeEventListener("storage",this.refreshResults),super.disconnectedCallback()}createRenderRoot(){return this}render(){return n`
      ...
      <main class="app-shell conductor-shell" id="conductor-main">
        ...
        ${this.errorMessage?n`<div class="error-summary" role="alert" tabindex="-1" id="conductor-error">
        ...
        <section class="panel conductor-panel" aria-labelledby="collection-heading">
          ...
          ${this.collectionMode==="qualtrics"?n`<label class="full-width">
        ...
        <section class="panel conductor-panel" aria-labelledby="link-heading">
          ...
          ${this.generatedConfig?n`<div class="generated-link" role="region" aria-labelledby="generated-link-heading">
                ...
                <div class="button-row compact">
                  ...
                  ${this.generatedConfig.collection.mode==="local"?n`<a class="secondary-button link-button" href=${this.participantUrl} target="_blank" rel="noopener">Open participant page</a>`:c}
                  <button class="secondary-button" type="button" @click=${this.downloadConfiguration}>Download configuration JSON</button>
                </div>
                ${this.generatedConfig.collection.mode==="qualtrics"?n`<div class="qualtrics-setup" role="region" aria-labelledby="qualtrics-setup-heading">
        ...
        <section class="panel conductor-panel" aria-labelledby="results-heading">
          ...
          ${this.completedResults.length?n`
              ...
              `:n`<p>After a configured questionnaire is completed in this same browser, its pseudonymous record will appear here.</p>`}
        </section>
