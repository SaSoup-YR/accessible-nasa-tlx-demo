import{r as I,s as F,a as d,t as H,i as _,g as E,D as R,v as y,b as W,c as K,d as Y,f as A,e as J,h as U,j as Z,P as M,A as c,k as n,l as L,m as G,n as X,o as ee,p as te,q as ie}from"./shared-BcpyGktZ.js";const se="accessible-questionnaire:qualtrics-submit:v2",ae="accessible-questionnaire:qualtrics-receipt:v2",ne="accessible-questionnaire:qualtrics-parent-ready:v2",re="accessible-questionnaire:qualtrics-child-ready:v2",b="0.8.2-q2";function oe(e=window){const t=e.accessibleQuestionnaireResultSink??e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function le(e,t=window,i=()=>{}){if(e.collection.mode!=="qualtrics")return null;const s=de(e.collection.parentOrigin,t,i),a=ce(e.collection.parentOrigin,t,12e3,()=>s.getState()==="connected");return t.accessibleQuestionnaireResultSink=a,t.accessibleNasaTlxResultSink=a,{sink:a,bridge:s}}function de(e,t=window,i=()=>{}){let s="connecting",a=null;const r=(p,h)=>{s==="connected"||s==="failed"&&p!=="connected"||(s=p,i({state:s,message:h}))},u=p=>{if(p.source!==t.parent||p.origin!==e)return;const h=p.data;if(h?.type===ne){if(h.protocolVersion!==2||h.bridgeBuild!==b){r("failed",`This Qualtrics survey is using an old or incomplete bridge. Expected ${b}. Do not start this questionnaire.`);return}a!==null&&(t.clearTimeout(a),a=null),t.parent.postMessage({type:re,protocolVersion:2,bridgeBuild:b},e),r("connected",`Secure Qualtrics bridge ${b} connected.`)}};return t.addEventListener("message",u),i({state:s,message:`Checking Qualtrics bridge ${b}.`}),a=t.setTimeout(()=>{a=null,s!=="connected"&&r("failed",`The required Qualtrics bridge ${b} did not connect. Do not start this questionnaire.`)},8500),{getState:()=>s,disconnect(){a!==null&&(t.clearTimeout(a),a=null),t.removeEventListener("message",u)}}}function ce(e,t=window,i=12e3,s=()=>!0){return{name:"UCL Qualtrics",submit(a){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):s()?new Promise((r,u)=>{let p=!1;const h=f=>{p||(p=!0,t.clearTimeout(k),t.removeEventListener("message",g),f())},g=f=>{if(f.source!==t.parent||f.origin!==e)return;const m=f.data;if(!(!m||m.type!==ae||m.submissionId!==a.submissionId||m.bridgeBuild!==b)){if(m.accepted!==!0){h(()=>u(new Error(typeof m.error=="string"&&m.error?m.error:"Qualtrics did not accept the response.")));return}h(()=>r({accepted:!0,submissionId:a.submissionId,receiptId:typeof m.receiptId=="string"?m.receiptId:void 0}))}},k=t.setTimeout(()=>{h(()=>u(new Error("Qualtrics did not acknowledge the response in time.")))},i);t.addEventListener("message",g),t.parent.postMessage({type:se,bridgeBuild:b,record:a},e)}):Promise.reject(new Error(`Qualtrics bridge ${b} is not connected. The response remains in the local backup.`))}}}async function ue(e,t,i=15e3){let s;const a=new Promise((u,p)=>{s=setTimeout(()=>p(new Error("The study platform did not confirm receipt in time.")),i)});let r;try{r=await Promise.race([t.submit(e),a])}finally{s!==void 0&&clearTimeout(s)}if(!r||r.accepted!==!0||r.submissionId!==e.submissionId||r.receiptId!==void 0&&typeof r.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return r}const j=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),C=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]);for(const e of I){const t=String(e).split("").map(i=>[...C].find(([,s])=>s===i)?.[0]).filter(i=>!!i).join(" ");t&&j.set(t,e)}const O=new Set([...C.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),P=/\b(?:not|no|cancel|neither|except|without|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:anything\s+but|other\s+than|don\s+t)\b/,he={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function T(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function q(e){return P.test(T(e))}function Q(e,t){const i=e.map(a=>a.trim()).filter(Boolean);if(i.length===0||q(i[0]))return null;const s=i.map((a,r)=>({transcript:a,value:t(a),index:r})).filter(a=>a.value!==null);return s.length===0||i.slice(0,s[0].index).some(q)||new Set(s.map(({value:a})=>a)).size!==1?null:{transcript:s[0].transcript,value:s[0].value}}function pe(e,t){const i=e.split(" ").filter(Boolean),s=[];for(const a of i)if(/^(?:100|[0-9]{1,2})$/.test(a)){const r=Number(a);s.push(t.includes(r)?r:null)}for(let a=0;a<i.length;){if(!O.has(i[a])){a+=1;continue}const r=[];for(;a<i.length&&O.has(i[a]);)r.push(i[a]),a+=1;const u=r.length===1&&C.has(r[0])?Number(C.get(r[0])):j.get(r.join(" "));s.push(u!==void 0&&t.includes(u)?u:null)}return s}function B(e){return e?.map(t=>t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|")}function w(e,t){return e.find(i=>i.position===t)?.value}function ge(e,t,i){const s=/\b(middle|midpoint|centre|center)\b/.test(e),a=B(t.voiceLowAliases),r=B(t.voiceHighAliases);if(!a||!r||i.length!==5)return;const u=`(?:${a})`,p=`(?:${r})`,h=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${u}\\b`).test(e),g=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${p}\\b`).test(e),k=t.voiceLowAliases?.includes("low")===!0&&e==="hello",f=new RegExp(`\\b${u}\\b`).test(e)||k,m=new RegExp(`\\b${p}\\b`).test(e);if(h||g)return[s,h,g].filter(Boolean).length!==1||h&&m||g&&f?null:h?w(i,"closer-low")??null:w(i,"closer-high")??null;if([s,f,m].some(Boolean))return[s,f,m].filter(Boolean).length!==1?null:s?w(i,"middle")??null:f?w(i,"low")??null:w(i,"high")??null}function me(e,t,i=I,s=F){const a=T(e);if(!a||P.test(a))return null;const r=pe(a,i),u=ge(a,t,s);return r.length>0?r.length!==1||r[0]===null||u===null||u!==void 0&&u!==r[0]?null:r[0]:u??null}function fe(e,t){const i=T(e);if(!i||P.test(i))return null;const s=t.map(a=>{const r=typeof a=="string"?a:a.id;return(typeof a=="string"?he[r]??[r.replace(/[-_]/g," ")]:[a.name.toLowerCase(),r.replace(/[-_]/g," ")]).some(p=>i===p||i.includes(p))?r:null}).filter(a=>!!a);return s.length===1?s[0]:null}function be(e,t,i=I,s=F){return Q(e,a=>me(a,t,i,s))}function ye(e,t){return Q(e,i=>fe(i,t))}const z="3.5.3",ve=`https://cdn.jsdelivr.net/npm/webgazer@${z}/dist/webgazer.js`,we=`https://cdn.jsdelivr.net/npm/webgazer@${z}/dist/mediapipe/face_mesh`,$e="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let $=null;function V(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function Se(e=document){return window.webgazer?Promise.resolve(window.webgazer):$||($=new Promise((t,i)=>{const s=e.querySelector("#webgazer-loader"),a=s??e.createElement("script"),r=()=>{window.webgazer?t(window.webgazer):i(new Error("WebGazer loaded without exposing its browser API."))};a.addEventListener("load",r,{once:!0}),a.addEventListener("error",()=>{a.remove(),i(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),s||(a.id="webgazer-loader",a.src=ve,a.integrity=$e,a.crossOrigin="anonymous",a.referrerPolicy="no-referrer",e.head.append(a))}).catch(t=>{throw $=null,t}),$)}class D{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,i){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=i,{progress:0,activated:!1};const s=Math.min(1,Math.max(0,(i-this.startedAt)/this.durationMs));return s>=1?(this.reset(),{progress:1,activated:!0}):{progress:s,activated:!1}}reset(){this.key=null,this.startedAt=0}}var Ce=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,l=(e,t,i,s)=>{for(var a=s>1?void 0:s?ze(t,i):t,r=e.length-1,u;r>=0;r--)(u=e[r])&&(a=(s?u(t,i,a):u(a))||a);return s&&a&&Ce(t,i,a),a};const S=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],v=3;function x(e){const t=U(e);for(let i=t.length-1;i>0;i-=1){const s=Math.floor(Math.random()*(i+1));[t[i],t[s]]=[t[s],t[i]]}return t}let o=class extends _{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=x(E(R)),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.hostBridgeState="not-required",this.hostBridgeMessage="",this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.configurationApplied=!1,this.installedResultSink=null,this.gazeCandidateTracker=new D(1e3),this.gazeConfirmationTracker=new D(1200),this.repeatSavedSessionOffer=()=>{this.savedSession&&(this.readAloudUsed=!0,this.speakText(this.savedSessionOfferSpeech(this.savedSession)))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!y(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.recoveredCompletedRecord=null,y(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig?.collection.mode==="qualtrics"&&this.hostBridgeState!=="connected"){this.showError(this.hostBridgeMessage||"The secure Qualtrics result connection is not ready. Do not start this questionnaire.");return}if(this.studyConfig&&(this.participantCode=this.participantCode.trim(),!y(this.participantCode))){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=this.dimensions.length-1)),this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.stage="ratings",this.ratingIndex=this.dimensions.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=W(this.definition,this.ratings,this.pairResponses),this.submittedRecord=K({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?oe():null;if(this.completionSavedLocally=this.studyConfig?Y(this.submittedRecord):!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`,this.announceAutomatic(this.statusMessage);try{this.hostReceipt=await ue(this.submittedRecord,e),this.completionSavedByHost=!0,this.hostSinkName=e.name}catch(t){this.hostSubmissionFailed=!0;const i=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${i} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("questionnaire-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInput(),this.clearError(),this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInput(),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=x(this.definition),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=""),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!V(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await Se();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=we,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<v-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<S.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=v,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.cancelGazeProposal(),this.resetGazeHover(),this.restoreWebGazerPreviewContainer(),this.releaseGazeResources(),this.gazeState="off",this.gazeMessage="Gaze input and camera stopped.",this.announceAutomatic(this.gazeMessage)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const i=this.dimensions[this.ratingIndex],s=e.value;this.selectRating(i.id,s,"voice"),t=this.answerMode==="smiley"&&this.smileyLandmarks.some(r=>r.value===s)?`smiley-${i.id}-${s}`:`rating-${i.id}-${s}`}else{const i=this.pairOrder[this.pairIndex],s=e.value;this.selectPair(i.id,s,"voice"),t=`${i.id}-${s}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&!this.savedSession&&this.recoveredCompletedRecord&&this.updateComplete.then(()=>{const e=this.querySelector("#completed-backup-heading");e&&A(e,{block:"start",onReveal:()=>this.requestParentReveal(e)})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.installedResultSink?.bridge.disconnect(),this.installedResultSink=null,this.stopReading(!1),this.releaseRecognition(),this.stopGazeInput(),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=J(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(t&&(this.studyConfig=t,this.pairOrder=x(this.definition),this.applyConfiguredSupport(),t.collection.mode==="qualtrics")){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}this.hostBridgeState="connecting",this.installedResultSink=le(t,window,({state:i,message:s})=>{this.hostBridgeState=i,this.hostBridgeMessage=s})}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get definition(){return E(this.studyConfig?.instrumentId??R)}get dimensions(){return this.definition.items}get pairs(){return U(this.definition)}get ratingValues(){return Z(this.definition)}get smileyLandmarks(){return this.definition.landmarks??[]}get dimensionById(){return new Map(this.dimensions.map(e=>[e.id,e]))}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return n`
    ...
    `}renderFullRatingScale(e,t){return n`
      <fieldset class="rating-fieldset">
        ...
        <div class="rating-grid">
          ${this.ratingValues.map(i=>{const s=`rating-${e.id}-${i}`;return n`
              <label
                class="rating-option"
                for=${s}
                data-gaze-target
    ...
    `}renderSmileyResponse(e,t){return n`
      <fieldset class="smiley-response">
        ...
        <div class="smiley-grid">
          ${this.smileyLandmarks.map(({value:i,cue:s})=>{const a=`smiley-${e.id}-${i}`;return n`
              <label
                class="smiley-option"
                for=${a}
                data-gaze-target
    ...
    `}renderPair(){const e=this.pairOrder[this.pairIndex],t=this.dimensionById.get(e.left),i=this.dimensionById.get(e.right),s=this.pairResponses[e.id];return n`
    ...
    `}renderPairChoice(e,t,i){const s=`${e}-${t.id}`;return n`
      <label
        class="choice-card"
        for=${s}
        data-gaze-target
    ...
    `}renderVoiceInput(e,t,i){if(!this.voiceInputAvailable)return c;const s=!!(window.SpeechRecognition??window.webkitSpeechRecognition),a=this.pendingVoiceAnswer?.context===e,r=e==="rating"?this.ratingVoicePrompt(t):`Say “${t.name}” or “${i.name}”.`;return n`
    ...
    `}renderNavigation(e,t){const i=t==="rating"&&this.ratingIndex===this.dimensions.length-1,s=t==="pair"&&this.pairIndex===this.pairOrder.length-1,a=i?this.pairOrder.length?"Continue to comparisons":"Review responses":s?"Review responses":"Next question";return n`
      ...
      <section class="panel" id="question-panel" aria-labelledby="review-heading">
        ...
        ${this.pairOrder.length?n`<h3>Pairwise comparisons</h3>
              <ol class="review-list">
                ${this.pairOrder.map(e=>{const t=this.dimensionById.get(e.left),i=this.dimensionById.get(e.right),s=this.dimensionById.get(this.pairResponses[e.id]);return n`<li>${t.name} or ${i.name}: <strong>${s.name}</strong></li>`})}
              </ol>`:c}
