import{r as A,a as l,t as F,i as D,v as y,d as g,c as N,b as B,s as H,e as v,f as j,A as c,g as n,h as b,p as S,P as U,j as I,k as P,l as W,m as _,n as K,o as J}from"./study-AYUfVuDI.js";const Q="accessible-nasa-tlx:qualtrics-submit:v1",Y="accessible-nasa-tlx:qualtrics-receipt:v1",X="accessible-nasa-tlx:qualtrics-resize:v1";function Z(e=window){const t=e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function ee(e,t=window){if(e.collection.mode!=="qualtrics")return null;const s=se(e.collection.parentOrigin,t);return t.accessibleNasaTlxResultSink=s,te(e.collection.parentOrigin,t),s}function te(e,t=window){const s=t.ResizeObserver;if(t.parent===t||typeof s!="function")return null;const i=()=>{const d=t.document.documentElement,u=t.document.body,p=Math.ceil(Math.max(d?.scrollHeight??0,d?.offsetHeight??0,u?.scrollHeight??0,u?.offsetHeight??0));p>0&&t.parent.postMessage({type:X,height:p},e)},a=new s(i);return t.document.documentElement&&a.observe(t.document.documentElement),t.document.body&&a.observe(t.document.body),t.requestAnimationFrame(i),a}function se(e,t=window,s=12e3){return{name:"UCL Qualtrics",submit(i){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):new Promise((a,d)=>{let u=!1;const p=$=>{u||(u=!0,t.clearTimeout(m),t.removeEventListener("message",h),$())},h=$=>{if($.source!==t.parent||$.origin!==e)return;const f=$.data;if(!(!f||f.type!==Y||f.submissionId!==i.submissionId)){if(f.accepted!==!0){p(()=>d(new Error(typeof f.error=="string"&&f.error?f.error:"Qualtrics did not accept the response.")));return}p(()=>a({accepted:!0,submissionId:i.submissionId,receiptId:typeof f.receiptId=="string"?f.receiptId:void 0}))}},m=t.setTimeout(()=>{p(()=>d(new Error("Qualtrics did not acknowledge the response in time.")))},s);t.addEventListener("message",h),t.parent.postMessage({type:Q,record:i},e)})}}}async function ie(e,t,s=15e3){let i;const a=new Promise((u,p)=>{i=setTimeout(()=>p(new Error("The study platform did not confirm receipt in time.")),s)});let d;try{d=await Promise.race([t.submit(e),a])}finally{i!==void 0&&clearTimeout(i)}if(!d||d.accepted!==!0||d.submissionId!==e.submissionId||d.receiptId!==void 0&&typeof d.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return d}const O=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),q=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]);for(const e of A){const t=String(e).split("").map(s=>[...q].find(([,i])=>i===s)?.[0]).filter(s=>!!s).join(" ");t&&O.set(t,e)}const T=new Set([...q.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),x=/\b(?:not|no|cancel|neither|except|without|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:anything\s+but|other\s+than|don\s+t)\b/,ae={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function R(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function E(e){return x.test(R(e))}function V(e,t){const s=e.map(a=>a.trim()).filter(Boolean);if(s.length===0||E(s[0]))return null;const i=s.map((a,d)=>({transcript:a,value:t(a),index:d})).filter(a=>a.value!==null);return i.length===0||s.slice(0,i[0].index).some(E)||new Set(i.map(({value:a})=>a)).size!==1?null:{transcript:i[0].transcript,value:i[0].value}}function ne(e){const t=e.split(" ").filter(Boolean),s=[];for(const i of t)if(/^(?:100|[0-9]{1,2})$/.test(i)){const a=Number(i);s.push(A.includes(a)?a:null)}for(let i=0;i<t.length;){if(!T.has(t[i])){i+=1;continue}const a=[];for(;i<t.length&&T.has(t[i]);)a.push(t[i]),i+=1;s.push(O.get(a.join(" "))??null)}return s}function re(e,t){const s=/\b(middle|midpoint|centre|center)\b/.test(e),i=t.id==="performance"?"(?:good|successful)":"(?:low|lo)",a=t.id==="performance"?"(?:poor|pour|bad|unsuccessful)":"(?:high|hi)",d=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${i}\\b`).test(e),u=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${a}\\b`).test(e),p=new RegExp(`\\b${i}\\b`).test(e),h=new RegExp(`\\b${a}\\b`).test(e);if(d||u)return[s,d,u].filter(Boolean).length!==1||d&&h||u&&p?null:d?25:75;if([s,p,h].some(Boolean))return[s,p,h].filter(Boolean).length!==1?null:s?50:p?0:100}function oe(e,t){const s=R(e);if(!s||x.test(s))return null;const i=ne(s),a=re(s,t);return i.length>0?i.length!==1||i[0]===null||a===null||a!==void 0&&a!==i[0]?null:i[0]:a??null}function le(e,t){const s=R(e);if(!s||x.test(s))return null;const i=t.filter(a=>ae[a].some(d=>s===d||s.includes(d)));return i.length===1?i[0]:null}function de(e,t){return V(e,s=>oe(s,t))}function ce(e,t){return V(e,s=>le(s,t))}const k="3.5.3",ue=`https://cdn.jsdelivr.net/npm/webgazer@${k}/dist/webgazer.js`,he=`https://cdn.jsdelivr.net/npm/webgazer@${k}/dist/mediapipe/face_mesh`,pe="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let C=null;function M(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function ge(e=document){return window.webgazer?Promise.resolve(window.webgazer):C||(C=new Promise((t,s)=>{const i=e.querySelector("#webgazer-loader"),a=i??e.createElement("script"),d=()=>{window.webgazer?t(window.webgazer):s(new Error("WebGazer loaded without exposing its browser API."))};a.addEventListener("load",d,{once:!0}),a.addEventListener("error",()=>{a.remove(),s(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),i||(a.id="webgazer-loader",a.src=ue,a.integrity=pe,a.crossOrigin="anonymous",a.referrerPolicy="no-referrer",e.head.append(a))}).catch(t=>{throw C=null,t}),C)}class L{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,s){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=s,{progress:0,activated:!1};const i=Math.min(1,Math.max(0,(s-this.startedAt)/this.durationMs));return i>=1?(this.reset(),{progress:1,activated:!0}):{progress:i,activated:!1}}reset(){this.key=null,this.startedAt=0}}var me=Object.defineProperty,be=Object.getOwnPropertyDescriptor,o=(e,t,s,i)=>{for(var a=i>1?void 0:i?be(t,s):t,d=e.length-1,u;d>=0;d--)(u=e[d])&&(a=(i?u(t,s,a):u(a))||a);return i&&a&&me(t,s,a),a};const z=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],w=3;function G(){const e=[...S];for(let t=e.length-1;t>0;t-=1){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}let r=class extends D{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=G(),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.savedSessionAnnouncementTimer=null,this.errorRevealFrame=null,this.configurationApplied=!1,this.gazeCandidateTracker=new L(1e3),this.gazeConfirmationTracker=new L(1200),this.toggleSavedSessionOfferSpeech=()=>{if(this.readingAloud){this.stopReading(!0);return}this.savedSession&&this.speakText(this.savedSessionOfferSpeech(this.savedSession))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!y(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.recoveredCompletedRecord=null,y(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig&&(this.participantCode=this.participantCode.trim(),!y(this.participantCode))){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=g.length-1)),this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.stage="ratings",this.ratingIndex=g.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=N(this.pairOrder,this.pairResponses,this.ratings),this.submittedRecord=B({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?Z():null;if(this.completionSavedLocally=this.studyConfig?H(this.submittedRecord):!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`,this.announceAutomatic(this.statusMessage);try{this.hostReceipt=await ie(this.submittedRecord,e),this.completionSavedByHost=!0,this.hostSinkName=e.name}catch(t){this.hostSubmissionFailed=!0;const s=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${s} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInput(),this.clearError(),this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInput(),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=G(),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=""),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!M(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await ge();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=he,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<w-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<z.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=w,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.cancelGazeProposal(),this.resetGazeHover(),this.restoreWebGazerPreviewContainer(),this.releaseGazeResources(),this.gazeState="off",this.gazeMessage="Gaze input and camera stopped.",this.announceAutomatic(this.gazeMessage)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const s=g[this.ratingIndex],i=e.value;this.selectRating(s.id,i,"voice"),t=this.answerMode==="smiley"&&v.some(d=>d.value===i)?`smiley-${s.id}-${i}`:`rating-${s.id}-${i}`}else{const s=this.pairOrder[this.pairIndex],i=e.value;this.selectPair(s.id,i,"voice"),t=`${s.id}-${i}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&(this.savedSession||this.recoveredCompletedRecord)&&this.updateComplete.then(()=>{const e=this.querySelector(this.savedSession?"#saved-session-heading":"#completed-backup-heading");e?.focus(),e?.scrollIntoView?.({block:"start"})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.savedSessionAnnouncementTimer!==null&&(window.clearTimeout(this.savedSessionAnnouncementTimer),this.savedSessionAnnouncementTimer=null),this.errorRevealFrame!==null&&(window.cancelAnimationFrame(this.errorRevealFrame),this.errorRevealFrame=null),this.stopReading(!1),this.releaseRecognition(),this.stopGazeInput(),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=j(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(t&&(this.studyConfig=t,this.applyConfiguredSupport(),t.collection.mode==="qualtrics")){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}ee(t)}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return n`
    ...
    `}renderStage(){switch(this.stage){case"intro":return this.renderIntro();case"ratings":return this.renderRating();case"pairs":return this.renderPair();case"review":return this.renderReview();case"complete":return this.renderComplete()}}renderIntro(){return n`
      <section class="panel" id="question-panel" aria-labelledby="intro-heading">
        ...
        <p>
          Think about ${this.studyConfig?n`the task: <strong>${this.studyConfig.taskLabel}</strong>`:"one task that you have just completed"}.
        </p>
    ...
    `:c}renderSupportSettings(e,t){const s=`support-${e}`;return n`
      <fieldset class="support-settings">
        ...
        ${t==="all"?n`<label class="toggle-card" for=${`${s}-simple`}>
            <input
              id=${`${s}-simple`}
              type="checkbox"
    ...
    `}renderGazeSetup(){if(!this.gazeInputAvailable)return c;const e=M(window.location),t=this.gazeState==="loading"||this.gazeState==="positioning"||this.gazeState==="calibrating"||this.gazeState==="ready";return n`
    ...
    `}renderGazeCalibration(){const e=z[this.gazeCalibrationIndex],t=this.gazeCalibrationIndex*w+this.gazeCalibrationRepetition,s=z.length*w;return n`
      <div class="gaze-calibration" role="dialog" aria-modal="true" aria-labelledby="gaze-calibration-heading">
        ...
        <div class="gaze-calibration-field">
          <button
            ...
            aria-label=${`Calibration point ${this.gazeCalibrationIndex+1} of ${z.length}, sample ${this.gazeCalibrationRepetition+1} of ${w}`}
    ...
    `}renderProgress(){const e=Object.keys(this.ratings).length+Object.keys(this.pairResponses).length,t=g.length+this.pairOrder.length,s=this.stage==="ratings"?"Ratings":this.stage==="pairs"?"Comparisons":"Review";return n`
    ...
    `}renderRating(){const e=g[this.ratingIndex],t=this.ratings[e.id];return n`
      <section class="panel" id="question-panel" aria-labelledby="rating-heading">
        ...
        ${this.showSimpleLanguage?n`<aside class="simple-language-panel" aria-label="Simpler explanation">
    ...
    `}renderFullRatingScale(e,t){return n`
      <fieldset class="rating-fieldset">
        ...
        <div class="rating-grid">
          ${A.map(s=>{const i=`rating-${e.id}-${s}`;return n`
              <label
                class="rating-option"
                for=${i}
                data-gaze-target
    ...
    `}renderSmileyResponse(e,t){return n`
      <fieldset class="smiley-response">
        ...
        <div class="smiley-grid">
          ${v.map(({value:s,cue:i})=>{const a=`smiley-${e.id}-${s}`;return n`
              <label
                class="smiley-option"
                for=${a}
                data-gaze-target
    ...
    `}renderPair(){const e=this.pairOrder[this.pairIndex],t=b.get(e.left),s=b.get(e.right),i=this.pairResponses[e.id];return n`
    ...
    `}renderPairHelp(e,t){return this.showSimpleLanguage?n`<p class="simple-pair-prompt">In simpler words: which one added more to the work you had to do?</p>`:n`
      <details
    ...
    `}renderVoiceInput(e,t,s){if(!this.voiceInputAvailable)return c;const i=!!(window.SpeechRecognition??window.webkitSpeechRecognition),a=this.pendingVoiceAnswer?.context===e,d=e==="rating"?this.ratingVoicePrompt(t):`Say “${t.name}” or “${s.name}”.`;return n`
    ...
    `}renderNavigation(e,t){const s=t==="rating"&&this.ratingIndex===g.length-1,i=t==="pair"&&this.pairIndex===this.pairOrder.length-1;return n`
    ...
    `}renderReview(){return n`
      <section class="panel" id="question-panel" aria-labelledby="review-heading">
        ...
        <ol class="review-list">
          ${this.pairOrder.map(e=>{const t=b.get(e.left),s=b.get(e.right),i=b.get(this.pairResponses[e.id]);return n`<li>${t.name} or ${s.name}: <strong>${i.name}</strong></li>`})}
        </ol>
    ...
    `}renderComplete(){if(!this.result||!this.submittedRecord)return c;const e=!this.studyConfig||this.studyConfig.showScoreToParticipant;return n`
      <section class="panel confirmation" id="question-panel" aria-labelledby="complete-heading">
        ...
        ${e?n`<p class="score">Weighted workload score: <strong>${this.result.weightedScore.toFixed(2)}</strong></p>`:n`<p>Your responses have been recorded. The study configuration does not display the calculated score on the participant page.</p>`}
    ...
    `}announceSavedSessionOffer(e){const t=`${e.configId}:${e.participantCode}:${e.savedAt}`;if(this.savedSessionAnnouncementKey===t)return;this.savedSessionAnnouncementKey=t;const s=this.savedSessionOfferSpeech(e);this.statusMessage="",this.updateComplete.then(()=>{this.savedSessionAnnouncementTimer!==null&&window.clearTimeout(this.savedSessionAnnouncementTimer),this.savedSessionAnnouncementTimer=window.setTimeout(()=>{this.savedSessionAnnouncementTimer=null;const i=this.savedSession;!this.isConnected||!i||i.savedAt!==e.savedAt||i.configId!==e.configId||i.participantCode!==e.participantCode||(this.statusMessage=s,this.audioGuidance&&this.speakText(s))},400)})}savedSessionOfferSpeech(e){return`Saved questionnaire found. ${Object.keys(e.ratings).length+Object.keys(e.pairResponses).length} of ${g.length+S.length} responses are saved in this browser. Select Resume saved questionnaire to continue, or Erase saved answers to remove the saved copy.`}renderSavedSessionOffer(){if(!this.savedSession)return c;const e=Object.keys(this.savedSession.ratings).length+Object.keys(this.savedSession.pairResponses).length;return n`
      <aside class="saved-session" aria-labelledby="saved-session-heading">
        ...
        <p>${e} of ${g.length+S.length} responses are saved in this browser.</p>
        <div class="button-row compact">
    ...
    `:c}renderResumeSummary(){return n`
      <aside class="resume-summary" aria-labelledby="resume-heading">
        ...
        <dl class="resume-details">
          <div><dt>Completed</dt><dd>${this.completedCount()} of ${g.length+S.length} responses</dd></div>
    ...
    `}setSimpleLanguage(e){const t=e.currentTarget.checked;this.recordSupportChange("simpler-explanations",this.showSimpleLanguage,t),this.showSimpleLanguage=t,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(t?this.currentSimpleExplanationSpeech():"Simpler explanations are off. The official questionnaire wording remains available.")}recordSupportChange(e,t,s){!this.studyConfig||t===s||this.stage==="complete"||(this.supportChanges=[...this.supportChanges,{setting:e,from:t,to:s,stage:this.stage,changedAt:new Date().toISOString()}])}setAnswerMode(e){this.recordSupportChange("answer-mode",this.answerMode,e),this.answerMode=e,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(e==="smiley"?"Smiley landmark answer format selected. Each rating offers five labelled values, with the full precise scale available on request.":"Standard 21-point answer format selected. Each rating uses values from 0 to 100 in steps of 5.")}setLargeText(e){this.recordSupportChange("text-size",this.largeText?"large":"standard",e?"large":"standard"),this.largeText=e,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(`${e?"Large":"Standard"} text selected.`)}setRecovery(e){const t=e.currentTarget.checked;this.recordSupportChange("interruption-recovery",this.recoveryEnabled,t),this.recoveryEnabled=t,this.invalidatePendingSubmission(),this.recoveryEnabled?(this.rememberParticipantCodeForTab(),this.persistProgress()):(this.forgetParticipantCodeForTab(),this.clearSavedProgress()),this.announceAutomatic(t?"Interruption recovery is on. Incomplete answers will be stored in this browser.":"Interruption recovery is off. The saved in-progress copy has been removed.")}landmarkLabel(e,t){return t===0?e.lowAnchor:t===25?`Closer to ${e.lowAnchor}`:t===50?"Middle":t===75?`Closer to ${e.highAnchor}`:e.highAnchor}ratingVoicePrompt(e){if(this.answerMode!=="smiley")return"Say a number from 0 to 100 in steps of 5, such as 25 or 70.";const t=v.map(({value:s})=>this.landmarkLabel(e,s));return`For the most reliable voice input, say one shown value: 0, 25, 50, 75, or 100. You may instead say one visible label: ${t.slice(0,-1).join(", ")}, or ${t.at(-1)}.`}ratingVoiceAnswerLabel(e,t){return this.answerMode==="smiley"&&v.some(i=>i.value===t)?`${this.landmarkLabel(e,t)}, value ${t}, for ${e.name}`:`${t} for ${e.name}`}ratingRouteLabel(e){const t=this.ratingInputRoutes[e];return t==="smiley-landmark"?"smiley landmark":t==="voice"?"voice, confirmed":t==="gaze-standard-scale"?"gaze, standard scale, confirmed":t==="gaze-smiley-landmark"?"gaze, smiley landmark, confirmed":"full scale"}selectRating(e,t,s){s!=="voice"&&this.voiceState!=="idle"&&this.clearVoiceAnswer(),this.invalidatePendingSubmission();const i=this.gazeActivationInProgress?s==="smiley-landmark"?"gaze-smiley-landmark":"gaze-standard-scale":s;this.ratings={...this.ratings,[e]:t},this.ratingInputRoutes={...this.ratingInputRoutes,[e]:i},this.clearError();const a=b.get(e),d=this.answerMode==="smiley"&&v.some(u=>u.value===t);this.statusMessage=d?`${a.name}, ${this.landmarkLabel(a,t)}, value ${t}, selected.`:`${a.name}, ${t}, selected.`,this.announceAutomatic(this.statusMessage),this.persistProgress()}selectPair(e,t,s){s!=="voice"&&this.voiceState!=="idle"&&this.clearVoiceAnswer(),this.invalidatePendingSubmission();const i=this.gazeActivationInProgress?"gaze":s;this.pairResponses={...this.pairResponses,[e]:t},this.pairInputRoutes={...this.pairInputRoutes,[e]:i},this.clearError(),this.statusMessage=`${b.get(t).name} selected.`,this.announceAutomatic(this.statusMessage),this.persistProgress()}goNext(e){if(this.stopReading(),this.clearVoiceAnswer(),e==="rating"){const t=g[this.ratingIndex];if(this.ratings[t.id]===void 0){this.showError(`Choose a rating for ${t.name} before continuing.`);return}this.ratingIndex<g.length-1?this.ratingIndex+=1:(this.stage="pairs",this.pairIndex=0)}else{const t=this.pairOrder[this.pairIndex];if(!this.pairResponses[t.id]){this.showError("Choose which factor contributed more to workload before continuing.");return}this.pairIndex<this.pairOrder.length-1?this.pairIndex+=1:this.stage="review"}this.clearError(),this.persistProgress(),this.focusHeading()}effectiveStudyConfig(){return this.studyConfig?this.studyConfig:{schemaVersion:3,configId:"demo-config",createdAt:this.startedAt||new Date().toISOString(),prototypeVersion:U,studyId:"DEMO",studyTitle:"Technical demonstration",taskLabel:"a task completed before the questionnaire",showScoreToParticipant:!0,support:{showSimpleLanguage:!1,answerMode:"standard",largeText:!1,audioGuidance:!1,recoveryEnabled:!1,participantAdjustmentPolicy:"presentation-only",voiceInputAvailable:!0,gazeInputAvailable:!0},collection:{mode:"local"}}}currentSupportMetadata(){return{simplerExplanationsShownAtSubmission:this.showSimpleLanguage,largeTextUsedAtSubmission:this.largeText,answerModeAtSubmission:this.answerMode,recoveryEnabledAtSubmission:this.recoveryEnabled,interruptionSummaryShown:this.interruptionSummaryShown,readAloudUsed:this.readAloudUsed,automaticAudioGuidanceEnabledAtSubmission:this.audioGuidance,gazeUsed:this.gazeUsed,gazeActionCount:this.gazeActionCount,gazeEngine:this.gazeUsed?`WebGazer ${k}`:null,ratingInputRoutes:this.ratingInputRoutes,pairInputRoutes:this.pairInputRoutes,supportChanges:[...this.supportChanges]}}downloadRecordJson(e){I(`${P(e)}.json`,JSON.stringify(e,null,2),"application/json")}downloadRecordCsv(e){I(`${P(e)}.csv`,`\uFEFF${W([e])}`,"text/csv")}invalidatePendingSubmission(){this.submittedRecord&&this.completionSavedLocally&&!this.completionSavedByHost&&_(this.submittedRecord.submissionId),this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null}announceAutomatic(e){this.audioGuidance&&e.trim()&&this.speakText(e)}speakOpenedHelp(e,t){e.currentTarget.open&&this.announceAutomatic(t)}speakText(e){if(!("speechSynthesis"in window)||!("SpeechSynthesisUtterance"in window)){this.audioStatusMessage="Built-in audio is unavailable in this browser. External screen readers can still read the page.";return}const t=window.speechSynthesis,s=this.readingAloud||t.speaking||t.pending||t.paused,i=++this.speechRequestId,a=new SpeechSynthesisUtterance(e);a.lang="en-GB",a.rate=1,a.pitch=1,a.volume=1,a.onend=()=>{i===this.speechRequestId&&(this.readingAloud=!1,this.audioStatusMessage="Spoken guidance finished.")},a.onerror=u=>{if(i!==this.speechRequestId)return;this.readingAloud=!1;const p=u.error?` (${u.error})`:"";this.audioStatusMessage=`No audio was played because the browser reported a speech error${p}. Check the device volume and try the button again.`};const d=()=>{if(i===this.speechRequestId)try{t.speak(a),this.readingAloud=!0,this.readAloudUsed=!0,this.audioStatusMessage="Playing spoken guidance."}catch{this.readingAloud=!1,this.audioStatusMessage="Built-in audio could not start in this browser. Check the device volume and try the button again."}};s?(t.cancel(),window.setTimeout(d,0)):d()}stopReading(e=!1){this.speechRequestId+=1,"speechSynthesis"in window&&window.speechSynthesis.cancel(),this.readingAloud=!1,e&&(this.audioStatusMessage="Spoken guidance stopped.")}currentStepSpeech(){if(this.stage==="intro"){const t=this.studyConfig?`Think about ${this.studyConfig.taskLabel}.`:"Think about one task that you have just completed.",s=this.answerMode==="smiley"?"The rating format uses five labelled smiley landmarks. A precise scale is available on request.":"The rating format uses a 21-point scale from 0 to 100.";return`Before you begin. ${t} First rate six aspects of workload. ${s} Then make fifteen comparisons. Finally review and submit.`}if(this.stage==="ratings"){const t=g[this.ratingIndex],s=this.showSimpleLanguage?` Simpler explanation: ${t.simpleExplanation}`:"",i=this.answerMode==="smiley"?`Choose a smiley landmark: ${v.map(({value:a})=>`${this.landmarkLabel(t,a)}, value ${a}`).join("; ")}. A more precise value is available on the full scale.`:`Rate from 0, ${t.lowAnchor}, to 100, ${t.highAnchor}, in steps of 5.`;return`Rating ${this.ratingIndex+1} of 6. ${t.name}. Official definition: ${t.officialDefinition}.${s} ${i}`}if(this.stage==="pairs"){const t=this.pairOrder[this.pairIndex],s=b.get(t.left),i=b.get(t.right),a=this.showSimpleLanguage?` In simpler words, choose which one added more to the work you had to do. ${s.name}: ${s.shortMeaning}. ${i.name}: ${i.shortMeaning}.`:"";return`Comparison ${this.pairIndex+1} of 15. Which factor contributed more to workload? This is not a low to high rating. Choose ${s.name} or ${i.name}.${a}`}return this.stage==="review"?"Review your six ratings and fifteen source of workload comparisons before submitting.":this.studyConfig&&this.completionSavedByHost?"Answers accepted. The study platform is finishing automatically.":this.result?`Responses calculated.${!this.studyConfig||this.studyConfig.showScoreToParticipant?` Weighted workload score: ${this.result.weightedScore.toFixed(2)} out of 100.`:""} JSON and CSV backup buttons are available on this page.`:"Responses calculated."}currentSimpleExplanationSpeech(){if(this.stage==="ratings"){const e=g[this.ratingIndex];return`Simpler explanation for ${e.name}. ${e.simpleExplanation} Use the official scale when choosing your response.`}if(this.stage==="pairs"){const e=this.pairOrder[this.pairIndex],t=b.get(e.left),s=b.get(e.right);return`In simpler words, choose which one added more to the work you had to do. ${t.name}: ${t.shortMeaning}. ${s.name}: ${s.shortMeaning}.`}return"Simpler explanations are on. Official questionnaire wording remains visible."}resumeSummarySpeech(){return`Welcome back. ${this.completedCount()} of ${g.length+S.length} responses completed. Last saved response: ${this.lastSavedDescription()}. Current position: ${this.currentPositionDescription()}. Next action: ${this.nextActionDescription()}`}async showGazePositioningStep(e){this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showPredictionPoints(!1),this.webgazer.showVideoPreview(!0),this.webgazer.showFaceOverlay(!0),this.webgazer.showFaceFeedbackBox(!0),this.gazeState="positioning",this.gazeMessage=e,this.announceAutomatic(this.gazeMessage),await this.updateComplete,this.mountWebGazerPreview(),this.querySelector("#gaze-positioning-heading")?.focus())}mountWebGazerPreview(){const e=this.querySelector(".gaze-camera-preview-slot"),t=document.querySelector("#webgazerVideoContainer");!e||!t||(t.setAttribute("aria-hidden","true"),e.append(t))}restoreWebGazerPreviewContainer(){const e=document.querySelector("#webgazerVideoContainer");e&&e.parentElement!==document.body&&document.body.append(e)}handleGazePoint(e){if(this.gazeState!=="ready"||!e){this.resetGazeHover();return}const t=this.elementsAtGazePoint(e);if(this.gazePendingElement){const u=t.map(m=>m.closest("[data-gaze-confirm], [data-gaze-cancel]")).find(m=>m!==null)??null,p=u?.hasAttribute("data-gaze-confirm")?"confirm":u?.hasAttribute("data-gaze-cancel")?"cancel":null,h=this.gazeConfirmationTracker.update(p,performance.now());this.gazeDwellProgress=h.progress,h.activated&&p==="confirm"&&this.confirmGazeProposal(),h.activated&&p==="cancel"&&this.cancelGazeProposal();return}const s=t.map(u=>u.closest("[data-gaze-target]")).find(u=>u!==null)??null,i=s&&!s.matches(":disabled")?s:null;i!==this.gazeCandidateElement&&(this.resetGazeHover(),this.gazeCandidateElement=i);const a=i?.dataset.gazeLabel??i?.textContent?.trim()??null,d=this.gazeCandidateTracker.update(a,performance.now());this.setGazeHover(i,d.progress),i&&d.activated&&(this.gazePendingElement=i,this.gazePendingLabel=a??"selected control",this.gazeDwellProgress=0,this.resetGazeHover(),this.statusMessage=`${this.gazePendingLabel} proposed by gaze. Confirm or cancel.`,this.announceAutomatic(this.statusMessage))}elementsAtGazePoint(e){if(typeof document.elementsFromPoint=="function")return document.elementsFromPoint(e.x,e.y).filter(s=>s instanceof HTMLElement);const t=document.elementFromPoint(e.x,e.y);return t instanceof HTMLElement?[t]:[]}setGazeHover(e,t){this.gazeCandidateElement=e,this.gazeDwellProgress=t,e&&(e.classList.add("gaze-hover"),e.style.setProperty("--gaze-progress",`${t*100}%`))}resetGazeHover(){this.gazeCandidateTracker.reset(),this.gazeCandidateElement&&(this.gazeCandidateElement.classList.remove("gaze-hover"),this.gazeCandidateElement.style.removeProperty("--gaze-progress")),this.gazeCandidateElement=null,this.gazePendingElement||(this.gazeDwellProgress=0)}releaseGazeResources(){const e=this.webgazer;if(e){this.restoreWebGazerPreviewContainer();try{e.clearGazeListener()}catch{}try{e.removeMouseEventListeners()}catch{}try{e.stopVideo()}catch{}try{e.end()}catch{}Promise.resolve(e.clearData()).catch(()=>{}),this.webgazer=null}}startVoiceInput(e,t,s){this.stopReading();const i=window.SpeechRecognition??window.webkitSpeechRecognition;if(!i)return;this.releaseRecognition(),this.pendingVoiceAnswer=null,this.voiceMessage="Listening for one answer.",this.voiceState="listening";const a=new i;this.recognition=a,a.lang="en-GB",a.continuous=!1,a.interimResults=!1,a.maxAlternatives=5,a.onresult=d=>{if(this.recognition!==a)return;const u=d.results[0],p=[];for(let h=0;u&&h<u.length;h+=1){const m=u[h]?.transcript?.trim();m&&p.push(m)}if(e==="rating"){const h=de(p,t);if(h){this.releaseRecognition(a);const m=this.ratingVoiceAnswerLabel(t,h.value);this.pendingVoiceAnswer={context:e,transcript:h.transcript,value:h.value,label:m},this.voiceState="pending",this.voiceMessage=`Proposed answer: ${m}. Confirm this answer or try again.`,this.announceAutomatic(this.voiceMessage),this.updateComplete.then(()=>this.querySelector("[data-voice-confirm]")?.focus());return}}else{const h=ce(p,[t.id,s.id]);if(h){this.releaseRecognition(a);const m=b.get(h.value).name;this.pendingVoiceAnswer={context:e,transcript:h.transcript,value:h.value,label:m},this.voiceState="pending",this.voiceMessage=`Proposed answer: ${m}. Confirm this answer or try again.`,this.announceAutomatic(this.voiceMessage),this.updateComplete.then(()=>this.querySelector("[data-voice-confirm]")?.focus());return}}this.releaseRecognition(a),this.voiceState="error",this.voiceMessage=`The answer was not recognised. ${e==="rating"?this.ratingVoicePrompt(t):`Say ${t.name} or ${s.name}.`}`,this.announceAutomatic(this.voiceMessage)},a.onerror=d=>{this.recognition===a&&(this.releaseRecognition(a),this.voiceState="error",this.voiceMessage=d.error==="not-allowed"?"Microphone permission was not granted. Use the visible answer buttons or system voice control.":"Voice recognition did not complete. Use the visible answer buttons or try again.",this.announceAutomatic(this.voiceMessage))},a.onend=()=>{this.recognition===a&&(this.recognition=null,this.voiceState==="listening"&&(this.voiceState="error",this.voiceMessage="No answer was recognised. Try again or use the visible answer buttons.",this.announceAutomatic(this.voiceMessage)))};try{a.start()}catch{this.releaseRecognition(a),this.voiceState="error",this.voiceMessage="Voice recognition could not start in this browser context.",this.announceAutomatic(this.voiceMessage)}}releaseRecognition(e=this.recognition){if(e){this.recognition===e&&(this.recognition=null),e.onresult=null,e.onerror=null,e.onend=null;try{e.stop()}catch{}}}currentProgressStorageKey(){const e=this.studyConfig?this.participantCode:"DEMO";return y(e)?K(this.studyConfig?.configId??"demo-config",e):null}currentTabParticipantCodeKey(){return this.studyConfig?`accessible-nasa-tlx-v0.7-tab-participant:${this.studyConfig.configId}`:null}rememberParticipantCodeForTab(){const e=this.currentTabParticipantCodeKey();if(!(!e||!this.recoveryEnabled||!y(this.participantCode)))try{sessionStorage.setItem(e,this.participantCode)}catch{}}forgetParticipantCodeForTab(){const e=this.currentTabParticipantCodeKey();if(e)try{sessionStorage.removeItem(e)}catch{}}restoreParticipantCodeForTab(){const e=this.currentTabParticipantCodeKey();if(!(!e||!this.recoveryEnabled||y(this.participantCode)))try{const t=sessionStorage.getItem(e);if(!t||!y(t))return;this.participantCode=t,this.participantCodeRestoredForTab=!0,this.statusMessage="Participant code restored for this tab. Checking for interrupted answers."}catch{}}persistProgress(){if(!this.recoveryEnabled||!this.isInProgress())return;const e=this.currentProgressStorageKey();if(!e)return;const t={version:3,savedAt:Date.now(),startedAt:this.startedAt||new Date().toISOString(),configId:this.studyConfig?.configId??"demo-config",participantCode:this.studyConfig?this.participantCode:"DEMO",stage:this.stage,ratingIndex:this.ratingIndex,pairIndex:this.pairIndex,pairOrder:this.pairOrder,pairResponses:this.pairResponses,ratings:this.ratings,ratingInputRoutes:this.ratingInputRoutes,pairInputRoutes:this.pairInputRoutes,supportChanges:this.supportChanges,support:{answerMode:this.answerMode,showSimpleLanguage:this.showSimpleLanguage,largeText:this.largeText,audioGuidance:this.audioGuidance}};try{localStorage.setItem(e,JSON.stringify(t))}catch{this.statusMessage="Progress could not be saved by this browser.",this.announceAutomatic(this.statusMessage)}}applySavedRecoveryPresentation(e){this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)}findSavedSession(){const e=this.currentProgressStorageKey();if(e)try{const t=localStorage.getItem(e);if(!t)return;const s=JSON.parse(t);this.validSavedSession(s)?(this.savedSession=s,this.applySavedRecoveryPresentation(s),this.announceSavedSessionOffer(s)):this.clearSavedProgress()}catch{this.clearSavedProgress()}}findCompletedBackup(){if(!this.studyConfig||!y(this.participantCode))return;const e=J().filter(t=>t.study.configId===this.studyConfig.configId&&t.participantCode===this.participantCode);this.recoveredCompletedRecord=e.at(-1)??null}validSavedSession(e){return e?.version===3&&e.configId===(this.studyConfig?.configId??"demo-config")&&e.participantCode===(this.studyConfig?this.participantCode:"DEMO")&&typeof e.startedAt=="string"&&["ratings","pairs","review"].includes(e.stage)&&Array.isArray(e.pairOrder)&&e.pairOrder.length===S.length&&Number.isInteger(e.ratingIndex)&&Number.isInteger(e.pairIndex)&&Array.isArray(e.supportChanges)}clearSavedProgress(){const e=this.currentProgressStorageKey();if(e)try{localStorage.removeItem(e)}catch{}}isInProgress(){return this.stage==="ratings"||this.stage==="pairs"||this.stage==="review"}completedCount(){return Object.keys(this.ratings).length+Object.keys(this.pairResponses).length}lastSavedDescription(){if(this.stage==="ratings"){const e=this.ratings[g[this.ratingIndex].id]!==void 0?this.ratingIndex:this.ratingIndex-1;return e>=0?`${g[e].name} rating`:"No response yet"}return this.stage==="pairs"?this.pairResponses[this.pairOrder[this.pairIndex].id]?`Comparison ${this.pairIndex+1}`:this.pairIndex>0?`Comparison ${this.pairIndex}`:"Frustration rating":"Comparison 15"}currentPositionDescription(){return this.stage==="ratings"?`Rating ${this.ratingIndex+1} of ${g.length}: ${g[this.ratingIndex].name}`:this.stage==="pairs"?`Comparison ${this.pairIndex+1} of ${this.pairOrder.length}`:this.stage==="review"?"Review responses":"Questionnaire introduction"}nextActionDescription(){if(this.stage==="ratings")return`Choose or check the ${g[this.ratingIndex].name} rating, then select Next.`;if(this.stage==="pairs"){const e=this.pairOrder[this.pairIndex];return`Choose ${b.get(e.left).name} or ${b.get(e.right).name}, then select Next.`}return"Check the saved answers, then submit or return to a question."}showError(e){this.errorMessage=e,this.announceAutomatic(`There is a problem. ${e}`),this.updateComplete.then(()=>{const t=this.querySelector("#error-summary");t&&(t.focus({preventScroll:!0}),this.errorRevealFrame!==null&&window.cancelAnimationFrame(this.errorRevealFrame),this.errorRevealFrame=window.requestAnimationFrame(()=>{this.errorRevealFrame=null,t.scrollIntoView?.({behavior:"auto",block:"start",inline:"nearest"})}))})}clearError(){this.errorMessage=""}focusHeading(){this.updateComplete.then(()=>{window.scrollTo({top:0});const e=this.querySelector("#question-panel h2");e&&(e.tabIndex=-1,e.focus(),this.statusMessage=e.textContent?.trim()??"",this.audioGuidance&&this.speakText(this.currentStepSpeech()))})}};o([l()],r.prototype,"stage",2);o([l()],r.prototype,"ratingIndex",2);o([l()],r.prototype,"pairIndex",2);o([l()],r.prototype,"pairOrder",2);o([l()],r.prototype,"pairResponses",2);o([l()],r.prototype,"ratings",2);o([l()],r.prototype,"ratingInputRoutes",2);o([l()],r.prototype,"pairInputRoutes",2);o([l()],r.prototype,"supportChanges",2);o([l()],r.prototype,"answerMode",2);o([l()],r.prototype,"showSimpleLanguage",2);o([l()],r.prototype,"largeText",2);o([l()],r.prototype,"recoveryEnabled",2);o([l()],r.prototype,"resumeSummaryVisible",2);o([l()],r.prototype,"savedSession",2);o([l()],r.prototype,"recoveredCompletedRecord",2);o([l()],r.prototype,"readingAloud",2);o([l()],r.prototype,"readAloudUsed",2);o([l()],r.prototype,"audioGuidance",2);o([l()],r.prototype,"audioStatusMessage",2);o([l()],r.prototype,"interruptionSummaryShown",2);o([l()],r.prototype,"voiceState",2);o([l()],r.prototype,"voiceMessage",2);o([l()],r.prototype,"pendingVoiceAnswer",2);o([l()],r.prototype,"errorMessage",2);o([l()],r.prototype,"statusMessage",2);o([l()],r.prototype,"result",2);o([l()],r.prototype,"gazeState",2);o([l()],r.prototype,"gazeMessage",2);o([l()],r.prototype,"gazeCalibrationIndex",2);o([l()],r.prototype,"gazeCalibrationRepetition",2);o([l()],r.prototype,"gazePendingLabel",2);o([l()],r.prototype,"gazeDwellProgress",2);o([l()],r.prototype,"gazeUsed",2);o([l()],r.prototype,"gazeActionCount",2);o([l()],r.prototype,"studyConfig",2);o([l()],r.prototype,"configurationError",2);o([l()],r.prototype,"participantCode",2);o([l()],r.prototype,"participantCodeError",2);o([l()],r.prototype,"participantCodeRestoredForTab",2);o([l()],r.prototype,"startedAt",2);o([l()],r.prototype,"submittedRecord",2);o([l()],r.prototype,"completionSavedLocally",2);o([l()],r.prototype,"completionSavedByHost",2);o([l()],r.prototype,"hostSubmissionFailed",2);o([l()],r.prototype,"hostSinkName",2);o([l()],r.prototype,"hostReceipt",2);o([l()],r.prototype,"submittingResult",2);r=o([F("accessible-nasa-tlx")],r);
