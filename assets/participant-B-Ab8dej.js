import{r as J,s as Y,a as h,t as Z,i as ae,g as B,D as S,v,b as re,c as oe,d as le,f as k,e as de,h as ce,j as X,k as ue,P as V,A as u,l as r,m as D,n as N,o as he,p as pe,q as ge,u as me}from"./shared-BAIUlwW6.js";const fe="accessible-questionnaire:qualtrics-submit:v2",be="accessible-questionnaire:qualtrics-receipt:v2",ye="accessible-questionnaire:qualtrics-parent-ready:v2",ve="accessible-questionnaire:qualtrics-child-ready:v2",we="accessible-questionnaire:qualtrics-advance-failed:v2",y="0.8.7-q7";function Se(e=window){const t=e.accessibleQuestionnaireResultSink??e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function $e(e,t=window,i=()=>{},s=()=>{}){if(e.collection.mode!=="qualtrics")return null;const a=Ce(e.collection.parentOrigin,t,i,s),n=ze(e.collection.parentOrigin,t,12e3,()=>a.getState()==="connected");return t.accessibleQuestionnaireResultSink=n,t.accessibleNasaTlxResultSink=n,{sink:n,bridge:a}}function Ce(e,t=window,i=()=>{},s=()=>{}){let a="connecting",n=null;const o=(m,p)=>{a==="connected"||a==="failed"&&m!=="connected"||(a=m,i({state:a,message:p}))},c=m=>{if(m.source!==t.parent||m.origin!==e)return;const p=m.data;if(p?.type===we){p.bridgeBuild===y&&typeof p.error=="string"&&p.error.trim()&&s(p.error);return}if(p?.type===ye){if(p.protocolVersion!==2||p.bridgeBuild!==y){o("failed",`This Qualtrics survey is using an old or incomplete bridge. Expected ${y}. Do not start this questionnaire.`);return}n!==null&&(t.clearTimeout(n),n=null),t.parent.postMessage({type:ve,protocolVersion:2,bridgeBuild:y},e),o("connected",`Secure Qualtrics bridge ${y} connected.`)}};return t.addEventListener("message",c),i({state:a,message:`Checking Qualtrics bridge ${y}.`}),n=t.setTimeout(()=>{n=null,a!=="connected"&&o("failed",`The required Qualtrics bridge ${y} did not connect. Do not start this questionnaire.`)},8500),{getState:()=>a,disconnect(){n!==null&&(t.clearTimeout(n),n=null),t.removeEventListener("message",c)}}}function ze(e,t=window,i=12e3,s=()=>!0){return{name:"UCL Qualtrics",submit(a){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):s()?new Promise((n,o)=>{let c=!1;const m=f=>{c||(c=!0,t.clearTimeout(w),t.removeEventListener("message",p),f())},p=f=>{if(f.source!==t.parent||f.origin!==e)return;const g=f.data;if(!(!g||g.type!==be||g.submissionId!==a.submissionId||g.bridgeBuild!==y)){if(g.accepted!==!0){m(()=>o(new Error(typeof g.error=="string"&&g.error?g.error:"Qualtrics did not accept the response.")));return}m(()=>n({accepted:!0,submissionId:a.submissionId,receiptId:typeof g.receiptId=="string"?g.receiptId:void 0}))}},w=t.setTimeout(()=>{m(()=>o(new Error("Qualtrics did not acknowledge the response in time.")))},i);t.addEventListener("message",p),t.parent.postMessage({type:fe,bridgeBuild:y,record:a},e)}):Promise.reject(new Error(`Qualtrics bridge ${y} is not connected. The response remains in the local backup.`))}}}async function Re(e,t,i=15e3){let s;const a=new Promise((o,c)=>{s=setTimeout(()=>c(new Error("The study platform did not confirm receipt in time.")),i)});let n;try{n=await Promise.race([t.submit(e),a])}finally{s!==void 0&&clearTimeout(s)}if(!n||n.accepted!==!0||n.submissionId!==e.submissionId||n.receiptId!==void 0&&typeof n.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return n}const M=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),A=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]),R=new Map([["won",1],["to",2],["too",2],["tree",3],["free",3],["for",4],["fore",4],["fife",5],["ate",8]]),F=["zero","one","two","three","four","five","six","seven","eight","nine","ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen"],U=["","","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety"];function ee(e){if(e<20)return F[e];if(e===100)return"one hundred";const t=Math.floor(e/10),i=e%10;return i===0?U[t]:`${U[t]} ${F[i]}`}for(let e=0;e<=100;e+=1){M.set(ee(e),e);const t=String(e).split("").map(i=>[...A].find(([,s])=>s===i)?.[0]).filter(i=>!!i).join(" ");t&&M.set(t,e)}const L=new Set([...A.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),O=/\b(?:not|note|knot|naught|nought|no|nope|nah|never|cannot|cancel|neither|except|without|minus|negative|skip|avoid|exclude|reject|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:(?:anything|everything)\s+but|other\s+than|don\s+t|can\s+t|won\s+t|wouldn\s+t|shouldn\s+t|isn\s+t|wasn\s+t)\b/,te={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function x(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function xe(e,t,i,s=!0){const a=[];for(const n of t){const o=Number.isInteger(n)&&n>=0&&n<=100?ee(n):String(n);if(a.push(String(n),o,`number ${o}`,`option ${o}`,`rating ${o}`,`value ${o}`,`answer ${o}`,`choice ${o}`),s){const c=e.responseLabels?.[String(n)];c?.trim()&&a.push(c.trim(),`answer ${c.trim()}`,`choose ${c.trim()}`)}}return s&&(a.push(e.lowAnchor,e.highAnchor,...e.voiceLowAliases??[],...e.voiceHighAliases??[]),i.length===5&&a.push("middle","midpoint",`closer to ${e.lowAnchor}`,`closer to ${e.highAnchor}`)),[...new Set(a.map(n=>n.trim()).filter(Boolean))]}function ke(e){return[...new Set(e.flatMap(t=>typeof t!="string"?[t.name,t.id.replace(/[-_]/g," ")]:te[t]??[t.replace(/[-_]/g," ")]).map(t=>t.trim()).filter(Boolean))]}function ie(e){return O.test(x(e))}function se(e,t){const i=e.map(n=>n.trim()).filter(Boolean);if(i.length===0)return null;const s=i.map((n,o)=>({transcript:n,value:t(n),index:o}));if(s.some(({transcript:n,value:o})=>o===null&&ie(n)))return null;const a=s.filter(n=>n.value!==null);return a.length===0?null:{transcript:a[0].transcript,value:a[0].value}}function H(e,t){return new Set([e,...t??[]].map(x).filter(Boolean))}function q(e){return e.replace(/^(?:(?:i\s+)?(?:choose|select|pick)|(?:my\s+)?answer(?:\s+is)?|(?:the\s+)?(?:number|option|rating|value|response|choice)(?:\s+is)?)\s+/,"").trim()}function j(e){return e.replace(/\bdis\s+a\s+gr(?:ay|ey)\b/g,"disagree").replace(/\ba\s+gr(?:ay|ey)\b/g,"agree").replace(/\bstrong\s+lee\b/g,"strongly").replace(/\bdisagreed\b/g,"disagree").replace(/\bagreed\b/g,"agree").replace(/^neither\s+(.+)\s+or\s+(.+)$/,"neither $1 nor $2")}function Ie(e,t,i){const s=q(e),a=H(t.lowAnchor,t.voiceLowAliases).has(s),n=H(t.highAnchor,t.voiceHighAliases).has(s);if(!(!a&&!n))return a&&n?null:a?i[0]:i.at(-1)??null}function Ae(e,t,i){if(!t.responseLabels)return;const s=j(q(e)),a=i.filter(n=>j(x(t.responseLabels?.[String(n)]??""))===s);if(a.length!==0)return a.length===1?a[0]:null}function Pe(e,t){const i=q(e),s=i.split(" ").filter(Boolean);if(s.length===0||!s.every(o=>/^(?:100|[0-9]{1,2})$/.test(o)||L.has(o)||R.has(o)))return;const n=ne(i,t,!0);return n.length!==1||n[0]===null?null:n[0]}function ne(e,t,i=!1){const s=e.split(" ").filter(Boolean),a=[];for(const n of s)if(/^(?:100|[0-9]{1,2})$/.test(n)){const o=Number(n);a.push(t.includes(o)?o:null)}for(let n=0;n<s.length;){if(!L.has(s[n])&&!(i&&R.has(s[n]))){n+=1;continue}const o=[];for(;n<s.length&&(L.has(s[n])||i&&R.has(s[n]));)o.push(s[n]),n+=1;const c=o.length===1&&A.has(o[0])?Number(A.get(o[0])):o.length===1&&R.has(o[0])?R.get(o[0]):M.get(o.join(" "));a.push(c!==void 0&&t.includes(c)?c:null)}return a}function Q(e){return e?.map(t=>t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|")}function C(e,t){return e.find(i=>i.position===t)?.value}function Te(e,t,i){const s=/\b(middle|midpoint|centre|center)\b/.test(e),a=Q(t.voiceLowAliases),n=Q(t.voiceHighAliases);if(!a||!n||i.length!==5)return;const o=`(?:${a})`,c=`(?:${n})`,m=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${o}\\b`).test(e),p=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${c}\\b`).test(e),w=t.voiceLowAliases?.includes("low")===!0&&e==="hello",f=new RegExp(`\\b${o}\\b`).test(e)||w,g=new RegExp(`\\b${c}\\b`).test(e);if(m||p)return[s,m,p].filter(Boolean).length!==1||m&&g||p&&f?null:m?C(i,"closer-low")??null:C(i,"closer-high")??null;if([s,f,g].some(Boolean))return[s,f,g].filter(Boolean).length!==1?null:s?C(i,"middle")??null:f?C(i,"low")??null:C(i,"high")??null}function Ee(e,t,i=J,s=Y){const a=x(e);if(!a)return null;const n=Ae(a,t,i);if(n!==void 0)return n;const o=Ie(a,t,i);if(o!==void 0)return o;if(O.test(a))return null;const c=Te(a,t,s),m=Pe(a,i);if(m!==void 0)return m===null||c===null||c!==void 0&&c!==m?null:m;if(c===null)return null;if(c!==void 0){const p=ne(a,i);return p.length===0?c:p.length!==1||p[0]===null||p[0]!==c?null:c}return null}function Me(e,t){const i=x(e);if(!i||O.test(i))return null;const s=t.map(a=>{const n=typeof a=="string"?a:a.id;return(typeof a=="string"?te[n]??[n.replace(/[-_]/g," ")]:[a.name.toLowerCase(),n.replace(/[-_]/g," ")]).some(c=>i===c||i.includes(c))?n:null}).filter(a=>!!a);return s.length===1?s[0]:null}function Le(e,t,i=J,s=Y){return se(e,a=>Ee(a,t,i,s))}function Oe(e,t){return se(e,i=>Me(i,t))}const P="3.5.3",qe=`https://cdn.jsdelivr.net/npm/webgazer@${P}/dist/webgazer.js`,Ge=`https://cdn.jsdelivr.net/npm/webgazer@${P}/dist/mediapipe/face_mesh`,Be="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let z=null;function _(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function Ve(e=document){return window.webgazer?Promise.resolve(window.webgazer):z||(z=new Promise((t,i)=>{const s=e.querySelector("#webgazer-loader"),a=s??e.createElement("script"),n=()=>{window.webgazer?t(window.webgazer):i(new Error("WebGazer loaded without exposing its browser API."))};a.addEventListener("load",n,{once:!0}),a.addEventListener("error",()=>{a.remove(),i(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),s||(a.id="webgazer-loader",a.src=qe,a.integrity=Be,a.crossOrigin="anonymous",a.referrerPolicy="no-referrer",e.head.append(a))}).catch(t=>{throw z=null,t}),z)}class W{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,i){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=i,{progress:0,activated:!1};const s=Math.min(1,Math.max(0,(i-this.startedAt)/this.durationMs));return s>=1?(this.reset(),{progress:1,activated:!0}):{progress:s,activated:!1}}reset(){this.key=null,this.startedAt=0}}var De=Object.defineProperty,Ne=Object.getOwnPropertyDescriptor,d=(e,t,i,s)=>{for(var a=s>1?void 0:s?Ne(t,i):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(a=(s?o(t,i,a):o(a))||a);return s&&a&&De(t,i,a),a};function T(e){return e.trim().toLocaleLowerCase().split("-")[0]==="en"}const I=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],$=3;function E(e){const t=X(e);for(let i=t.length-1;i>0;i-=1){const s=Math.floor(Math.random()*(i+1));[t[i],t[s]]=[t[s],t[i]]}return t}let l=class extends ae{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=E(B(S)),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.submittingResult=!1,this.hostBridgeState="not-required",this.hostBridgeMessage="",this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.configurationApplied=!1,this.installedResultSink=null,this.gazeCandidateTracker=new W(1e3),this.gazeConfirmationTracker=new W(1200),this.repeatSavedSessionOffer=()=>{this.savedSession&&(this.readAloudUsed=!0,this.speakText(this.savedSessionOfferSpeech(this.savedSession)))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!v(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,v(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig?.collection.mode==="qualtrics"&&this.hostBridgeState!=="connected"){this.showError(this.hostBridgeMessage||"The secure Qualtrics result connection is not ready. Do not start this questionnaire.");return}if(this.studyConfig&&(this.participantCode=this.participantCode.trim(),!v(this.participantCode))){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=this.dimensions.length-1)),this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.stage="ratings",this.ratingIndex=this.dimensions.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=re(this.definition,this.ratings,this.pairResponses),this.submittedRecord=oe({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?Se():null;if(this.completionSavedLocally=this.studyConfig?le(this.submittedRecord):!1,this.completionSavedByHost=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`;try{await Re(this.submittedRecord,e),this.completionSavedByHost=!0}catch(t){this.hostSubmissionFailed=!0;const i=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${i} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("questionnaire-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInputInternal(!1),this.clearError(),this.completionSavedByHost||this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInputInternal(!1),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=E(this.definition),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=""),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!_(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await Ve();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=Ge,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<$-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<I.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=$,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.stopGazeInputInternal(!0)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const i=this.dimensions[this.ratingIndex],s=e.value;this.selectRating(i.id,s,"voice"),t=this.answerMode==="smiley"&&this.smileyLandmarks.some(n=>n.value===s)?`smiley-${i.id}-${s}`:`rating-${i.id}-${s}`}else{const i=this.pairOrder[this.pairIndex],s=e.value;this.selectPair(i.id,s,"voice"),t=`${i.id}-${s}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&!this.savedSession&&this.recoveredCompletedRecord&&this.updateComplete.then(()=>{const e=this.querySelector("#completed-backup-heading");e&&k(e,{block:"start",onReveal:()=>this.requestParentReveal(e)})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.installedResultSink?.bridge.disconnect(),this.installedResultSink=null,this.stopReading(!1),this.releaseRecognition(),this.stopGazeInputInternal(!1),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=de(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(t&&(this.studyConfig=t,this.pairOrder=E(this.definition),this.applyConfiguredSupport(),t.collection.mode==="qualtrics")){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}this.hostBridgeState="connecting",this.installedResultSink=$e(t,window,({state:i,message:s})=>{this.hostBridgeState=i,this.hostBridgeMessage=s},i=>{this.remoteRecordingUnconfirmed=!0,this.statusMessage=i,this.announceAutomatic(this.currentStepSpeech()),this.updateComplete.then(()=>{const s=this.querySelector("#remote-recording-error");s&&k(s,{block:"start",onReveal:()=>this.requestParentReveal(s)})})})}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get definition(){const e=this.studyConfig?.instrumentId??S;return ce(e,this.studyConfig?.questionnaireDefinition)}get dimensions(){return this.definition.items}get pairs(){return X(this.definition)}get ratingValues(){return ue(this.definition)}get smileyLandmarks(){return this.definition.landmarks??[]}get isResearcherSuppliedDefinition(){return!!this.studyConfig?.questionnaireDefinition}get dimensionById(){return new Map(this.dimensions.map(e=>[e.id,e]))}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return r`
    ...
    `}renderStage(){switch(this.stage){case"intro":return this.renderIntro();case"ratings":return this.renderRating();case"pairs":return this.renderPair();case"review":return this.renderReview();case"complete":return this.renderComplete()}}renderIntro(){const e=this.definition.id===S?"Start the six ratings":`Start the ${this.dimensions.length} items`;return r`
      <section class="panel" id="question-panel" aria-labelledby="intro-heading">
        <h2 id="intro-heading">Before you begin</h2>
        ${this.configurationError?r`<div class="error-summary" role="alert"><h3>Study link problem</h3><p>${this.configurationError}</p></div>`:u}
        ...
        ${this.savedSessionProblem?r`<aside class="error-summary" role="status" aria-labelledby="saved-session-problem-heading">
        ...
        ${this.studyConfig?r`<p>Study task: <strong>${this.studyConfig.taskLabel}</strong></p>`:u}
        <ol class="process-overview">
          ...
          ${this.pairs.length?r`<li>Then, make ${this.pairs.length} pairwise comparisons.</li>`:u}
        ...
        ${this.studyConfig?this.canAdjustAllSupport?r`<details class="support-toolbar participant-support-setup">
              ...
              </details>`:u:r`<details class="support-toolbar participant-support-setup">
              <summary>Adjust accessibility support (optional)</summary>
              ${this.renderSupportSettings("intro","all")}
            </details>`}
    ...
    `:u}renderSupportSettings(e,t){const i=`support-${e}`;return r`
      <fieldset class="support-settings">
        ...
        ${t==="all"&&this.definition.supports.smileyLandmarks?r`<fieldset class="answer-mode-control">
            ...
            <label for=${`${i}-standard-answer`}>
              ...
              ${this.answerMode==="standard"?r`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:u}
            </label>
            <label for=${`${i}-smiley-answer`}>
              ...
              ${this.answerMode==="smiley"?r`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:u}
            </label>
          </fieldset>`:u}
    ...
    `}renderReadAloudControl(){const e="speechSynthesis"in window&&"SpeechSynthesisUtterance"in window;return r`
      <div class="quick-support audio-guidance" aria-label="Built-in audio guidance">
        ...
        ${this.audioStatusMessage?r`<p class="audio-status" role="status" aria-atomic="true">${this.audioStatusMessage}</p>`:u}
    ...
    `}renderGazeSetup(){if(!this.gazeInputAvailable)return u;const e=_(window.location),t=this.gazeState==="loading"||this.gazeState==="positioning"||this.gazeState==="calibrating"||this.gazeState==="ready";return r`
      <details class="gaze-setup" .open=${this.gazeState!=="off"}>
        ...
        <div class="gaze-setup-content">
          ...
          ${e?u:r`<p class="gaze-warning" role="status">
          ...
          ${this.gazeMessage?r`<p class="gaze-status" role="status">${this.gazeMessage}</p>`:u}
        </div>
      </details>
    ...
    `}renderGazeCalibration(){const e=I[this.gazeCalibrationIndex],t=this.gazeCalibrationIndex*$+this.gazeCalibrationRepetition,i=I.length*$;return r`
      <div class="gaze-calibration" role="dialog" aria-modal="true" aria-labelledby="gaze-calibration-heading">
        ...
        <div class="gaze-calibration-field">
          <button
            ...
            aria-label=${`Calibration point ${this.gazeCalibrationIndex+1} of ${I.length}, sample ${this.gazeCalibrationRepetition+1} of ${$}`}
    ...
    `}renderFullRatingScale(e,t){return r`
      <fieldset class="rating-fieldset">
        ...
        <div class="rating-grid">
          ${this.ratingValues.map(i=>{const s=`rating-${e.id}-${i}`,a=this.ratingOptionLabel(e,i);return r`
              <label
                class="rating-option"
                for=${s}
                data-gaze-target
              ...
              >
                ...
                <span class="rating-option-content">
                  <strong>${i}</strong>
                  ${e.responseLabels?.[String(i)]&&e.responseLabels[String(i)]!==String(i)?r`<small lang=${this.definition.language} dir="auto">${e.responseLabels[String(i)]}</small>`:u}
                </span>
                ${t===i?r`<span class="selected-marker selected-check" aria-hidden="true">✓</span>`:u}
              </label>
            `})}
        </div>
      </fieldset>
    `}renderSmileyResponse(e,t){return r`
      <fieldset class="smiley-response">
        ...
        <div class="smiley-grid">
          ${this.smileyLandmarks.map(({value:i,cue:s})=>{const a=`smiley-${e.id}-${i}`;return r`
              <label
                class="smiley-option"
                for=${a}
                data-gaze-target
              ...
              >
                ...
                <span class="smiley-option-content">
                  ...
                  ${t===i?r`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:u}
                </span>
              </label>
            `})}
        </div>
    ...
    `}renderPairChoice(e,t,i){const s=`${e}-${t.id}`;return r`
      ...
      >
        ...
        <span>
          ...
          ${this.showSimpleLanguage?r`<small>${t.shortMeaning}</small>`:u}
        </span>
        ${i?r`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:u}
      </label>
    ...
    `}renderVoiceInput(e,t,i){if(!this.voiceInputAvailable)return u;const s=!!(window.SpeechRecognition??window.webkitSpeechRecognition),a=this.pendingVoiceAnswer?.context===e,n=e==="rating"?this.ratingVoicePrompt(t):`Say “${t.name}” or “${i.name}”.`;return r`
      <details class="voice-input" .open=${this.voiceState!=="idle"}>
        ...
        <div class="voice-input-content">
          ...
          ${this.voiceMessage?r`<p role="status" aria-live="polite" aria-atomic="true">${this.voiceMessage}</p>`:u}
    ...
    `}renderNavigation(e,t){const i=t==="rating"&&this.ratingIndex===this.dimensions.length-1,s=t==="pair"&&this.pairIndex===this.pairOrder.length-1,a=i?this.pairOrder.length?"Continue to comparisons":"Review responses":s?"Review responses":"Next question";return r`
    ...
    `}renderComplete(){if(!this.result||!this.submittedRecord)return u;const e=!this.studyConfig||this.studyConfig.showScoreToParticipant;return r`
      <section class="panel confirmation" id="question-panel" aria-labelledby="complete-heading">
        ...
        ${this.studyConfig?this.remoteRecordingUnconfirmed?r`<div
              ...
              >
                ...
                ${this.completionSavedLocally?u:r`<p>
        ...
        ${!this.studyConfig||!this.completionSavedByHost||this.remoteRecordingUnconfirmed?this.renderCompletionReadAloudControl():u}
        ${this.studyConfig?u:r`<details>
        ...
        ${this.studyConfig&&this.completionSavedByHost?r`<aside class="submission-fallback" aria-labelledby="submission-fallback-heading">
              ...
              ${this.studyConfig?u:r`<button class="secondary-button large-answer-button" type="button" @click=${this.restart}>Start again</button>`}
            </div>`}
        ${this.studyConfig?this.completionSavedByHost&&!this.remoteRecordingUnconfirmed?u:r`<p>
    ...
    `}announceSavedSessionOffer(e){const t=`${e.configId}:${e.participantCode}:${e.savedAt}`;if(this.savedSessionAnnouncementKey===t)return;this.savedSessionAnnouncementKey=t;const i=this.savedSessionOfferSpeech(e);this.statusMessage="",this.updateComplete.then(()=>{const s=this.savedSession;if(!s||s.savedAt!==e.savedAt||s.configId!==e.configId||s.participantCode!==e.participantCode)return;const a=this.querySelector("#saved-session-offer");a&&k(a,{block:"center",forceCoordinateScroll:!0,onReveal:()=>this.requestParentReveal(a)}),window.setTimeout(()=>{const n=this.savedSession;!this.isConnected||!n||n.savedAt!==e.savedAt||n.configId!==e.configId||n.participantCode!==e.participantCode||(this.statusMessage=i,this.audioGuidance&&this.speakText(i))},650)})}savedSessionOfferSpeech(e){return`Saved questionnaire found. ${Object.keys(e.ratings).length+Object.keys(e.pairResponses).length} of ${this.dimensions.length+this.pairs.length} responses are saved in this browser. Resume saved questionnaire. Erase saved answers.`}renderSavedSessionOffer(){if(!this.savedSession)return u;const e=Object.keys(this.savedSession.ratings).length+Object.keys(this.savedSession.pairResponses).length;return r`
      <aside
    ...
    `:u}renderResumeSummary(){return r`
