import{w as ut,g as Ve,x as dt,M as ke,a as g,t as ct,i as pt,D as mt,m as pe,y as Ne,z as De,u as ht,o as ft,B as gt,h as yt,C as Oe,f as ve,P as be,A as $,l as u,k as me,j as vt,E as Me,F as bt}from"./shared-CP54t85t.js";const _e=`__js_AQP_ACCEPTED
...
`,z=20;let Fe=0;function fe(e={}){return Fe+=1,{key:`custom-item-${Fe}`,name:"",prompt:"",lowAnchor:"",highAnchor:"",simpleExplanation:"",reverseScored:!1,...e}}function je(){return{language:"en-GB",name:"",shortName:"",version:"1.0.0",description:"A researcher-supplied questionnaire.",introPrompt:"Answer each item about the task that you have just completed.",sourceLabel:"Researcher-supplied questionnaire",sourceUrl:"",scaleType:"agreement",minimum:1,maximum:5,step:1,scoreName:"Questionnaire score",aggregation:"mean",items:[fe({name:"Item 1"}),fe({name:"Item 2"})]}}function E(e,t){const i=e.trim().replace(/\s+/g," ");if(!i)throw new Error(`${t} is required.`);return i}function _t(e){return e.trim().toLowerCase().normalize("NFKD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,50)}function It(e,t){const i=t.trim()||e.trim();return i.length<=240?i:`${i.slice(0,237).trimEnd()}...`}function Ue(e){if(!Number.isInteger(e.minimum)||!Number.isInteger(e.maximum)||!Number.isInteger(e.step))throw new Error("Scale minimum, maximum and step must be whole numbers.");if(!Array.isArray(e.items)||e.items.length<1||e.items.length>z)throw new Error(`Add between 1 and ${z} questionnaire items.`);const t=E(e.name,"Questionnaire name"),i=E(e.shortName,"Short name"),n=_t(i||t);if(!n)throw new Error("Questionnaire name must contain at least one Latin letter or number for its stable ID.");const r=e.items.map((p,c)=>{const S=E(p.prompt,`Item ${c+1} question`),d=p.simpleExplanation.trim().replace(/\s+/g," ");return{id:`item-${String(c+1).padStart(2,"0")}`,name:E(p.name,`Item ${c+1} label`),prompt:S,...d?{simpleExplanation:d}:{},shortMeaning:It(S,d),lowAnchor:E(p.lowAnchor,`Item ${c+1} low endpoint`),highAnchor:E(p.highAnchor,`Item ${c+1} high endpoint`),...p.responseLabels?{responseLabels:p.responseLabels}:{}}}),o=e.items.flatMap((p,c)=>p.reverseScored?[`item-${String(c+1).padStart(2,"0")}`]:[]),a=r.every(p=>p.simpleExplanation),v=e.aggregation==="mean"?e.minimum:e.minimum*r.length,h=e.aggregation==="mean"?e.maximum:e.maximum*r.length,l={schemaVersion:1,language:E(e.language,"Questionnaire language"),id:`custom-${n}`,version:E(e.version,"Questionnaire version"),name:t,shortName:i,description:E(e.description,"Questionnaire description"),introPrompt:E(e.introPrompt,"Participant instruction"),officialContentNotice:"This questionnaire definition was supplied by the study conductor. Its wording, use and interpretation must match the approved study protocol.",source:{label:E(e.sourceLabel,"Source or authorship label"),...e.sourceUrl.trim()?{url:e.sourceUrl.trim()}:{}},scale:{type:e.scaleType,minimum:e.minimum,maximum:e.maximum,step:e.step},items:r,scoring:{strategy:e.aggregation==="mean"?"mean-v1":"sum-v1",scoreName:E(e.scoreName,"Score name"),minimum:v,maximum:h,...o.length?{reverseItemIds:o}:{}},supports:{simplerExplanations:a,smileyLandmarks:!1}};return Ye(l)}function Ye(e){const t=ut(e);if(Ve(t.id))throw new Error("A custom questionnaire cannot replace a built-in questionnaire ID.");if(!t.id.startsWith("custom-"))throw new Error("A custom questionnaire ID must start with custom-.");if(t.scoring.strategy!=="mean-v1"&&t.scoring.strategy!=="sum-v1")throw new Error("A custom questionnaire must use the reviewed mean or sum scorer.");if(t.pairwise)throw new Error("Custom questionnaires do not support pairwise comparisons.");if(t.landmarks||t.supports.smileyLandmarks)throw new Error("Custom questionnaires do not support smiley landmarks.");const i=dt(t);if(i>ke)throw new Error(`The questionnaire definition is ${i} bytes; the participant-link limit is ${ke} bytes.`);return t}function At(e){return`${e.id}-${e.version.replace(/[^A-Za-z0-9._-]+/g,"-")}.questionnaire.json`}const $t=2e6,Ae=/<\s*(?:script|iframe|object|embed|style)\b|(?:href|src)\s*=\s*["']?\s*javascript:|\son[a-z]+\s*=/i,$e=/<\s*(?:img|picture|video|audio|canvas|svg|math|form|input|button|select|textarea|table)\b/i,qe=/\$\{(?:e|q|lm|gr)?:?\/?\/|q:\/\/|\{(?:if|TOKEN|INSERTANS|[A-Za-z][A-Za-z0-9_.]*\.(?:NAOK|shown))\b/i;function R(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}function q(e){return typeof e=="string"||typeof e=="number"?String(e):""}function A(e){return e.replace(/\s+/g," ").trim()}function I(e,t){e.confirmationCodes.has(t.code)||(e.confirmationCodes.add(t.code),e.confirmations.push(t))}function G(e,t,i,n){const r=q(e);if(!r.trim())return n.unsupported.push({code:"missing-visible-text",title:`${t} is empty`,detail:`${i} does not contain participant-visible text.`}),null;if(Ae.test(r)||qe.test(r))return n.unsupported.push({code:"unsafe-dynamic-content",title:`${t} contains executable or dynamic content`,detail:`${i} contains script, an event handler, a JavaScript URL or survey-expression text. The importer does not execute or approximate it.`}),null;if($e.test(r))return n.unsupported.push({code:"unsupported-structured-content",title:`${t} contains media, a table or an interactive control`,detail:`${i} cannot be represented as one safe plain-text rating item without changing participant-visible content.`}),null;const a=new DOMParser().parseFromString(`<body>${r}</body>`,"text/html"),v=A(a.body.textContent??"");return v?((/<[^>]+>/.test(r)||v!==A(r))&&I(n,{code:"plain-text-normalisation",title:"Formatting was converted to plain text",detail:"Imported wording is rendered as safe plain text. Review it against the source export before use."}),v):(n.unsupported.push({code:"missing-visible-text",title:`${t} has no readable text`,detail:`${i} contains no participant-visible text after safe text extraction.`}),null)}function te(e){const t=typeof e=="number"?e:Number(q(e).trim());return Number.isInteger(t)?t:null}function se(e){if(e.length<2||e.some(i=>i<0||i>100)||new Set(e).size!==e.length)return!1;const t=e[1]-e[0];return t>0&&e.every((i,n)=>n===0||i-e[n-1]===t)}function Ke(e,t){if(!Array.isArray(e)||e.length!==Object.keys(t).length)return null;const i=e.map(String);return new Set(i).size===i.length&&i.every(n=>n in t)?i:null}function Ze(e,t,i,n){const r=R(e);return G(r?.Display,t,i,n)}function qt(e){return e.flatMap(i=>i.labels).map(i=>i.toLowerCase()).some(i=>i.includes("agree")||i.includes("disagree"))?"agreement":"semantic-differential"}function Tt(e){const t=e.split(/\s+/).map(n=>n.replace(/[^A-Za-z0-9]/g,"")[0]??"").join("").slice(0,12);return t?t.toUpperCase():e.replace(/[^A-Za-z0-9]+/g,"").slice(0,12)||"IMPORTED"}const Ct={SQI:"sq",AR:"ar",HYE:"hy",ASM:"as","AZ-AZ":"az-AZ",ID:"id",MS:"ms",BEL:"be",BN:"bn",BS:"bs","PT-BR":"pt-BR",BG:"bg",CA:"ca",CEB:"ceb","ZH-S":"zh-CN","ZH-T":"zh-TW",HR:"hr",CS:"cs",DA:"da",NL:"nl","EN-GB":"en-GB",EN:"en",EO:"eo",ET:"et",FI:"fi",FR:"fr","FR-CA":"fr-CA",KAT:"ka",DE:"de",EL:"el",GU:"gu",HE:"he",HI:"hi",HIL:"hil",HU:"hu",ISL:"is",IT:"it",JA:"ja",KAN:"kn",KAZ:"kk",KM:"km",KO:"ko",LV:"lv",LT:"lt",MK:"mk",MAL:"ml",MAR:"mr",MN:"mn","SR-ME":"sr-ME",MY:"my",NE:"ne",NO:"no",ORI:"or",FA:"fa",PL:"pl",PT:"pt","PA-IN":"pa-IN",RO:"ro",RU:"ru",SR:"sr",SIN:"si",SK:"sk",SL:"sl","ES-ES":"es-ES",ES:"es",SW:"sw",SV:"sv",TGL:"fil",TA:"ta",TEL:"te",TH:"th",TR:"tr",UK:"uk",UR:"ur",VI:"vi",CY:"cy"};function Xe(e,t="en"){const i=A(q(e))||t,n=Ct[i.toUpperCase()]??i.replace(/_/g,"-");if(!/^[A-Za-z]{2,3}(?:-[A-Za-z0-9]{2,8})*$/.test(n))return t;try{return Intl.getCanonicalLocales(n)[0]??t}catch{return t}}function et(e,t,i,n,r,o){if(!r.length)return o.unsupported.push({code:"no-supported-items",title:"No supported questionnaire items were found",detail:"This release needs at least one required, ordered single-choice rating item."}),null;if(r.length>z)return o.unsupported.push({code:"too-many-items",title:"The questionnaire has too many items for a participant link",detail:`${r.length} supported items were found; this release accepts at most ${z}.`}),null;const a=r[0].values;if(!se(a))return o.unsupported.push({code:"unsupported-response-values",title:"Response values are not one increasing whole-number scale",detail:"Values must be unique whole numbers from 0 to 100 with one constant positive step."}),null;const v=a.join("|");return r.some(h=>h.values.join("|")!==v)?(o.unsupported.push({code:"mixed-response-scales",title:"Items use different response values",detail:"The current participant interface requires every imported item to share the same ordered numeric scale."}),null):(I(o,{code:"review-scoring",title:"Scoring and reverse scoring require confirmation",detail:"Answer recodes do not establish a questionnaire score. Choose reviewed mean or sum, then mark any reverse-scored items."}),I(o,{code:"review-scale-type",title:"The scale description requires confirmation",detail:"Confirm whether the imported scale should be described as agreement or semantic differential."}),{language:n,name:e.slice(0,120),shortName:Tt(e),version:"1.0.0",description:`Questionnaire imported from ${t}.`,introPrompt:i.slice(0,400),sourceLabel:t,sourceUrl:"",scaleType:qt(r),minimum:a[0],maximum:a.at(-1),step:a[1]-a[0],scoreName:"Questionnaire score",aggregation:"mean",items:r.map(h=>fe({name:h.name.slice(0,120),prompt:h.prompt.slice(0,1e3),lowAnchor:h.labels[0].slice(0,80),highAnchor:h.labels.at(-1).slice(0,80),responseLabels:Object.fromEntries(h.values.map((l,p)=>[String(l),h.labels[p].slice(0,120)]))}))})}function re(e){return{code:`item-${e.sourceId}`,title:`${e.name}: imported`,detail:`${e.sourceId}; “${e.prompt}”; ordered choices: `+e.values.map((t,i)=>`${t} = ${e.labels[i]}`).join("; ")}}function he(e,t,i,n,r,o,a={}){return{source:e,sourceName:t,fileName:i,title:n,draft:r,imported:o.imported,confirmations:o.confirmations,unsupported:o.unsupported,canConvert:!!r&&o.unsupported.length===0,...a}}function tt(){return{imported:[],confirmations:[],unsupported:[],confirmationCodes:new Set}}function ze(e,t){const i=R(e);if(!i)throw new Error(t);return i}function Rt(e,t){const i=e.find(d=>d.Element==="BL"),n=Array.isArray(i?.Payload)?i.Payload.map(R).filter(d=>!!d):[],r=n.filter(d=>d.Type!=="Trash"),o=new Set(n.filter(d=>d.Type==="Trash").flatMap(d=>Array.isArray(d.BlockElements)?d.BlockElements:[]).map(R).filter(d=>!!d).map(d=>q(d.QuestionID)).filter(Boolean));o.size&&I(t,{code:"qualtrics-trash-ignored",title:"Questions in the Qualtrics Trash block were ignored",detail:`${o.size} deleted question${o.size===1?"":"s"} will not appear in the converted questionnaire.`});const a=e.find(d=>d.Element==="FL"),v=R(a?.Payload),h=Array.isArray(v?.Flow)?v.Flow.map(R).filter(d=>!!d):[];if(r.length!==1||h.length!==1||h[0].Type!=="Block")return t.unsupported.push({code:"qualtrics-complex-flow",title:"Qualtrics flow is outside the supported single-block subset",detail:"Use one ordinary question block only. Branches, randomisers, embedded-data flow and multiple blocks are not removed or flattened."}),{order:[],trashQuestionIds:o};const l=q(h[0].ID),p=r.find(d=>q(d.ID)===l);if(!p)return t.unsupported.push({code:"qualtrics-missing-block",title:"The active Qualtrics block could not be resolved",detail:`Survey Flow references ${l||"an unknown block"}.`}),{order:[],trashQuestionIds:o};const c=Array.isArray(p.BlockElements)?p.BlockElements:[],S=[];for(const d of c){const x=R(d);if(!x||x.Type!=="Question"||!q(x.QuestionID)){t.unsupported.push({code:"qualtrics-non-question-block-item",title:"The Qualtrics block contains unsupported content",detail:"Only ordered question entries are supported in the imported block."});continue}(x.SkipLogic||x.DisplayLogic)&&t.unsupported.push({code:"qualtrics-question-logic",title:`${q(x.QuestionID)} uses question logic`,detail:"Skip and display logic are not imported."}),S.push(q(x.QuestionID))}return{order:S,trashQuestionIds:o}}function Et(e){return["QuestionJS","JavaScript","DisplayLogic","SkipLogic","ChoiceDisplayLogic","CarryForward","Randomization","ChoiceRandomization"].some(t=>e[t]!==void 0&&e[t]!==null)}function Ge(e,t,i,n,r){const o=R(e[t]);if(!o)return r.unsupported.push({code:"qualtrics-missing-scale",title:`${n} has no answer scale`,detail:`${t} must contain every visible answer option.`}),null;const a=Ke(e[i],o);if(!a)return r.unsupported.push({code:"qualtrics-unknown-answer-order",title:`${n} has no reliable answer order`,detail:`${i} must list every ${t.toLowerCase()} entry exactly once.`}),null;const v=R(e.RecodeValues);let h;if(v){const p=a.map(c=>te(v[c]));if(p.some(c=>c===null))return r.unsupported.push({code:"qualtrics-nonnumeric-recodes",title:`${n} has missing or non-integer recode values`,detail:"Every visible option needs an explicit whole-number recode."}),null;h=p}else{if(!a.every((c,S)=>c===String(S+1)))return r.unsupported.push({code:"qualtrics-missing-scale",title:`${n} has no explicit recode table or default sequential choice IDs`,detail:"Without RecodeValues, ChoiceOrder must explicitly list the default IDs 1 through N. The importer will not infer values from other object keys."}),null;h=a.map((c,S)=>S+1),I(r,{code:"qualtrics-default-recodes",title:"Qualtrics default sequential recodes were used",detail:"The QSF omits RecodeValues and explicitly orders default choice IDs 1 through N. Confirm these values against the source survey before conversion."})}const l=a.map((p,c)=>Ze(o[p],`Answer ${c+1}`,`${n}/${p}`,r));return l.some(p=>p===null)?null:{values:h,labels:l}}function Qt(e,t){let i;try{i=JSON.parse(e)}catch{throw new Error("The Qualtrics QSF file is not valid JSON.")}const n=ze(i,"The Qualtrics QSF root must be a JSON object."),r=ze(n.SurveyEntry,"The file does not contain a Qualtrics SurveyEntry.");if(!Array.isArray(n.SurveyElements))throw new Error("The file does not contain Qualtrics SurveyElements.");const o=tt(),a=A(q(r.SurveyName))||"Imported Qualtrics questionnaire",v=Xe(r.SurveyLanguage,"en"),h=n.SurveyElements.map(R).filter(y=>!!y),{order:l,trashQuestionIds:p}=Rt(h,o),c=new Set(h.map(y=>q(y.Element)).filter(y=>y&&!["BL","FL","SQ"].includes(y)));c.size&&I(o,{code:"qualtrics-platform-settings-not-imported",title:"Qualtrics platform and presentation settings are not imported",detail:`The following non-question element types remain in Qualtrics only: ${[...c].sort().join(", ")}. Review the converted participant presentation.`});const S=new Map(h.filter(y=>y.Element==="SQ").map(y=>[q(y.PrimaryAttribute),R(y.Payload)]));if(l.length){const y=new Set(l);for(const _ of S.keys())!_||y.has(_)||p.has(_)||o.unsupported.push({code:"qualtrics-unreferenced-question",title:`${_} is outside the imported active block`,detail:"The importer will not silently omit an active question that is not represented by the supported single-block flow."})}const d=[];for(const y of l){const _=S.get(y);if(!_){o.unsupported.push({code:"qualtrics-missing-question",title:`${y} is missing`,detail:"The active block references a question that is not present in SurveyElements."});continue}if(Et(_)){o.unsupported.push({code:"qualtrics-unsupported-behaviour",title:`${y} contains logic, randomisation or code`,detail:"The importer does not execute or remove question behaviour."});continue}const B=R(_.Validation);if(R(B?.Settings)?.ForceResponse!=="ON"){o.unsupported.push({code:"qualtrics-optional-question",title:`${y} is not a forced-response question`,detail:"The participant platform currently requires every imported item."});continue}const W=G(_.QuestionText,"Question text",y,o);if(!W)continue;const J=q(_.QuestionType),F=q(_.Selector),T=q(_.SubSelector),oe=A(q(_.DataExportTag))||y;if(J==="MC"&&F==="SAVR"){const L=Ge(_,"Choices","ChoiceOrder",y,o);if(!L)continue;const k={sourceId:y,name:oe,prompt:W,...L};d.push(k),o.imported.push(re(k));continue}if(J==="Matrix"&&F==="Likert"&&T==="SingleAnswer"){const L=Ge(_,"Answers","AnswerOrder",y,o),k=R(_.Choices),ae=k?Ke(_.ChoiceOrder,k):null;if(!L||!k||!ae){ae||o.unsupported.push({code:"qualtrics-unknown-row-order",title:`${y} has no reliable matrix row order`,detail:"ChoiceOrder must list every matrix row exactly once."});continue}I(o,{code:"qualtrics-matrix-expanded",title:"Single-answer matrix rows were expanded into items",detail:"Review each generated item against the original matrix before conversion."}),ae.forEach((H,V)=>{const D=Ze(k[H],`Matrix row ${V+1}`,`${y}/${H}`,o);if(!D)return;const O={sourceId:`${y}/${H}`,name:D,prompt:`${W} — ${D}`,...L};d.push(O),o.imported.push(re(O))});continue}o.unsupported.push({code:"qualtrics-unsupported-question",title:`${y} uses an unsupported Qualtrics question type`,detail:`${J||"Unknown"} / ${F||"Unknown"} / ${T||"none"} is not converted. Supported: MC/SAVR and Matrix/Likert/SingleAnswer.`})}const ie=(q(r.SurveyDescription).trim()?G(r.SurveyDescription,"Survey description","SurveyEntry",o):null)??"Answer each imported item about the task that you have just completed.",ge=et(a,"Imported from Qualtrics QSF",ie,v,d,o);return he("qualtrics-qsf","Qualtrics QSF",t,a,ge,o)}function Q(e,t){const i=[...e.documentElement.children].find(r=>r.localName===t);if(!i)return[];const n=[...i.children].find(r=>r.localName==="rows");return n?[...n.children].filter(r=>r.localName==="row").map(r=>Object.fromEntries([...r.children].map(o=>[o.localName,o.textContent??""]))):[]}function U(e,t,i,n,r){return e.find(o=>o[t]===i&&(!o.language||o.language===r))?.[n]??""}const xt={answer_width:["0"],answer_order:["normal"],array_filter_style:["0"],clear_default:["N"],dropdown_prefix:["0"],hidden:["0"],hide_tip:["0"],max_answers:["1"],min_answers:["1"],other_comment_mandatory:["0"],other_numbers_only:["0"],other_position:["default"],page_break:["0"],public_statistics:["0"],random_order:["0"],save_as_default:["N"],scale_export:["0"],slider_rating:["0"],statistics_graphtype:["0"],statistics_showgraph:["1"],time_limit_action:["1"],time_limit_disable_next:["0"],time_limit_disable_prev:["0"],use_dropdown:["0"]};function Pt(e,t){if(!e.length)return;const i=e.filter(n=>{const r=n.attribute?.trim()??"",o=n.value?.trim()??"";return o?!xt[r]?.includes(o):!1});if(i.length){const n=i.slice(0,6).map(r=>`${r.qid||"unknown question"}: ${r.attribute||"unknown"}=${r.value||""}`).join("; ");t.unsupported.push({code:"limesurvey-question-attributes",title:"The LimeSurvey export contains active or unknown question attributes",detail:`${n}${i.length>6?`; and ${i.length-6} more`:""}. These settings may change validation, randomisation, timing or presentation and are not discarded.`});return}I(t,{code:"limesurvey-default-question-attributes",title:"Default LimeSurvey question settings were not imported",detail:"Only empty or known default attributes were present; no active validation, randomisation or timing rule was found. Review the converted participant presentation."})}function Be(e){if(!e.trim())return"";const i=new DOMParser().parseFromString(`<body>${e}</body>`,"text/html");return A(i.body.textContent??"")}function it(e){const t=e.map(r=>te(r.sortorder));if(t.some(r=>r===null))return!1;const i=t;if(new Set(i).size!==i.length)return!1;const n=i[0];return(n===0||n===1)&&i.every((r,o)=>r===n+o)}function nt(e){return e.every((t,i)=>t.code===`A${String(i+1).padStart(3,"0")}`)}function rt(e,t){if(e.type==="5")return[1,2,3,4,5];if(e.type!=="F"&&e.type!=="L"&&e.type!=="!")return null;const i=t.filter(o=>o.qid===e.qid&&(!o.scale_id||o.scale_id==="0")).sort((o,a)=>(Number(o.sortorder)||0)-(Number(a.sortorder)||0));if(!it(i))return null;const n=i.map(o=>te(o.code));if(n.every(o=>o!==null)&&se(n))return n;const r=i.map(o=>te(o.assessment_value));return r.every(o=>o!==null)&&se(r)?r:nt(i)?i.map((o,a)=>a+1):null}function Lt(e,t,i){const n=new Map;for(const r of e){if(r.mandatory!=="Y"||r.other&&r.other!=="N"||r.relevance&&r.relevance!=="1")continue;const o=rt(r,i);if(!o)continue;const a=r.type==="F"?t.filter(l=>l.parent_qid===r.qid).length:1;if(a<1)continue;const v=o.join("|"),h=n.get(v)??{questions:[],values:o,itemCount:0};h.questions.push(r),h.itemCount+=a,n.set(v,h)}return[...n.entries()].map(([r,o])=>({id:`values-${r.replace(/\|/g,"-")}`,name:o.questions.map(a=>a.title||a.qid).join(" + "),sourceQuestionCount:o.questions.length,itemCount:o.itemCount,responseValues:o.values,questionTypes:[...new Set(o.questions.map(a=>a.type||"unknown"))]}))}function We(e,t,i,n,r){const o=e.qid||e.title||"unknown-question",a=t.filter(c=>c.qid===e.qid&&(!c.scale_id||c.scale_id==="0")).sort((c,S)=>(Number(c.sortorder)||0)-(Number(S.sortorder)||0));if(!it(a))return r.unsupported.push({code:"limesurvey-answer-order",title:`${e.title||o} has no reliable answer order`,detail:"Every answer needs one unique consecutive sort order starting at 0 or 1."}),null;const v=a.map(c=>te(c.code)),h=a.map(c=>te(c.assessment_value));let l;if(v.every(c=>c!==null)&&se(v))l=v;else if(h.every(c=>c!==null)&&se(h))l=h,I(r,{code:"limesurvey-assessment-values",title:"LimeSurvey assessment values were used as response values",detail:"Verify every imported value against the LimeSurvey answer table."});else if(nt(a))l=a.map((c,S)=>S+1),I(r,{code:"limesurvey-positional-values",title:"LimeSurvey default answer codes were converted to ordered positions",detail:"The source uses A001 through A00N rather than numeric scores. The converted scale uses positions 1 through N. Confirm the intended values and scoring before conversion."});else return r.unsupported.push({code:"limesurvey-unsupported-values",title:`${e.title||o} has no safe increasing numeric recode`,detail:"Answer codes or assessment values must form one increasing whole-number scale with a constant step."}),null;const p=a.map((c,S)=>{const d=U(i,"aid",c.aid,"answer",n)||c.answer;return A(d??"")?G(d,`Answer ${S+1}`,`${e.title||o}/${c.code}`,r):(I(r,{code:"limesurvey-blank-scale-labels",title:"Blank scale positions will be shown as their numeric values",detail:"LimeSurvey leaves one or more intermediate labels blank. The converted questionnaire shows the reviewed numeric response value at those positions."}),String(l[S]))});return p.some(c=>!c)?null:{values:l,labels:p}}function kt(e,t,i,n){if(/<!DOCTYPE|<!ENTITY|<\?xml-stylesheet/i.test(e))throw new Error("The LimeSurvey file contains a DTD, entity or stylesheet declaration and was not parsed.");const o=new DOMParser().parseFromString(e,"application/xml");if(o.querySelector("parsererror"))throw new Error("The LimeSurvey file is not valid XML.");const a=o.querySelector("LimeSurveyDocType")?.textContent?.trim();if(a!=="Survey"&&a!=="Group"&&a!=="Question")throw new Error("The XML file is not a LimeSurvey survey, question-group or question export.");const v=a==="Group"?"limesurvey-lsg":a==="Question"?"limesurvey-lsq":"limesurvey-lss",h=a==="Group"?"LimeSurvey LSG":a==="Question"?"LimeSurvey LSQ":"LimeSurvey LSS",l=tt(),p=[...o.querySelectorAll("languages > language")].map(s=>s.textContent?.trim()??"").filter(Boolean),c=Q(o,"surveys"),d=A(c[0]?.language??"")||p[0]||"";!d||p.length&&!p.includes(d)?l.unsupported.push({code:"limesurvey-base-language",title:"The LimeSurvey base language could not be resolved",detail:"The survey language must match one language declared in the LSS export."}):p.length>1&&I(l,{code:"limesurvey-base-language-only",title:`Only the LimeSurvey base language (${d}) will be imported`,detail:`Additional languages (${p.filter(s=>s!==d).join(", ")}) remain in LimeSurvey and are not included in the converted definition. Confirm the intended participant language.`});const x=Q(o,"surveys_languagesettings"),ie=x.find(s=>!s.surveyls_language||s.surveyls_language===d)??x[0],ge=A(ie?.surveyls_title??"")||"Imported LimeSurvey questionnaire",y=Q(o,"questions").filter(s=>!s.language||!d||s.language===d),_=y.find(s=>!s.parent_qid||s.parent_qid==="0"),B=_?.gid||"__lsq__",N=a==="Question"?[{gid:B,group_order:"0",grelevance:"1",randomization_group:""}]:Q(o,"groups"),W=a==="Question"?[{gid:B,group_name:_?.title||"Imported LimeSurvey question",description:"",language:d}]:Q(o,"group_l10ns"),J=y.map(s=>({...s,gid:s.gid||B}));if(!N.length)throw new Error("The LimeSurvey export contains no questionnaire group.");const F=N.slice().sort((s,b)=>(Number(s.group_order)||0)-(Number(b.group_order)||0)).map(s=>{const b=W.find(C=>C.gid===s.gid&&(!C.language||C.language===d)),ne=J.filter(C=>C.gid===s.gid&&(!C.parent_qid||C.parent_qid==="0"));return{id:s.gid,name:A(b?.group_name??s.group_name??"")||`Group ${s.gid}`,questionCount:ne.length,questionTypes:[...new Set(ne.map(C=>C.type||"unknown"))]}});if(a==="Survey"&&N.length>1&&!i)return he(v,h,t,ge,null,l,{requiresGroupSelection:!0,groupOptions:F});const T=i?N.find(s=>s.gid===i):N[0];if(!T)throw new Error("Choose a questionnaire group contained in this LimeSurvey export.");const oe=W.find(s=>s.gid===T.gid&&(!s.language||s.language===d)),L=A(oe?.group_name??T.group_name??"")||`Group ${T.gid}`,k=J.filter(s=>s.gid===T.gid),H=Q(o,"subquestions").filter(s=>!s.language||!d||s.language===d).map(s=>({...s,gid:s.gid||B})).filter(s=>s.gid===T.gid||k.some(b=>b.qid===s.parent_qid)),V=k.filter(s=>!s.parent_qid||s.parent_qid==="0").sort((s,b)=>(Number(s.question_order)||0)-(Number(b.question_order)||0)),D=Q(o,"answers").filter(s=>!s.language||!d||s.language===d),O=Lt(V,H,D);if(a==="Survey"&&N.length>1&&I(l,{code:"limesurvey-selected-group-only",title:`Only “${L}” will be converted`,detail:`${N.length-1} other survey group${N.length===2?"":"s"} will remain outside the converted questionnaire. The researcher selected this group explicitly; no other group is silently flattened or removed.`}),a==="Question"&&I(l,{code:"limesurvey-question-context-not-retained",title:"The LimeSurvey question will run as a standalone questionnaire",detail:"An LSQ contains one question and its local answer settings, but not its original survey or group context. Confirm that standalone use is intended."}),T.grelevance&&T.grelevance!=="1"&&I(l,{code:"limesurvey-group-relevance-not-retained",title:"The source group display condition will not be retained",detail:`The LimeSurvey group condition is “${A(T.grelevance)}”. The converted questionnaire runs this selected group as a standalone instrument. Confirm that this is intended.`}),A(T.randomization_group??"")&&I(l,{code:"limesurvey-group-randomisation-not-retained",title:"The source group randomisation setting will not be retained",detail:"The converted questionnaire uses the reviewed exported question order. Confirm that a fixed order is suitable."}),O.length>1&&!n)return he(v,h,t,L,null,l,{groupOptions:F,selectedGroupId:T.gid,requiresRatingSetSelection:!0,ratingSetOptions:O});const Y=n?O.find(s=>s.id===n):O[0];if(n&&!Y)throw new Error("Choose a rating set contained in the selected LimeSurvey group.");const Te=Y?.responseValues.join("|"),ye=Te?V.filter(s=>rt(s,D)?.join("|")===Te&&s.mandatory==="Y"&&(!s.other||s.other==="N")&&(!s.relevance||s.relevance==="1")):V,Ce=new Set(ye.map(s=>s.qid)),Re=H.filter(s=>Ce.has(s.parent_qid)),le=new Set(ye.map(s=>s.qid));for(const s of Re)le.add(s.qid);const ue=V.filter(s=>!Ce.has(s.qid));Y&&ue.length&&I(l,{code:"limesurvey-selected-rating-set-only",title:`Only the ${Y.responseValues[0]}–${Y.responseValues.at(-1)} rating set will be converted`,detail:`${ue.length} other source question${ue.length===1?"":"s"} (${ue.map(s=>`${s.title||s.qid} [type ${s.type||"unknown"}]`).join(", ")}) will remain in LimeSurvey. They are listed here rather than silently removed or mixed into an invalid score.`}),Q(o,"conditions").filter(s=>le.has(s.qid)||le.has(s.cqid)).length&&l.unsupported.push({code:"limesurvey-conditions",title:"The selected LimeSurvey group contains question conditions",detail:"Branching and conditional relevance are not imported."});for(const[s,b]of[["assessments","assessment rules"],["defaultvalues","default answers"],["quotas","quota rules"],["quota_members","quota membership rules"],["quota_languages","localised quota messages"]])Q(o,s).length&&l.unsupported.push({code:`limesurvey-${s.replace(/_/g,"-")}`,title:`The LimeSurvey export contains ${b}`,detail:`${b[0].toUpperCase()}${b.slice(1)} are not executed or silently discarded.`});Pt(Q(o,"question_attributes").filter(s=>le.has(s.qid)),l);const K=Q(o,"question_l10ns"),Ee=Q(o,"answer_l10ns"),M=[];I(l,{code:"limesurvey-platform-settings-not-imported",title:"LimeSurvey platform and presentation settings are not imported",detail:"Theme, navigation, notification and publication settings remain in LimeSurvey. Review the converted participant presentation."});for(const s of ye){const b=s.qid||s.title||"unknown-question";if(s.mandatory!=="Y"){l.unsupported.push({code:"limesurvey-optional-question",title:`${s.title||b} is not mandatory`,detail:"The participant platform currently requires every imported item."});continue}if(s.other&&s.other!=="N"){l.unsupported.push({code:"limesurvey-other-answer",title:`${s.title||b} allows an “Other” answer`,detail:"Free-text “Other” responses are not imported."});continue}if(s.relevance&&s.relevance!=="1"){l.unsupported.push({code:"limesurvey-question-relevance",title:`${s.title||b} uses relevance logic`,detail:"Conditional questions are not imported."});continue}const ne=U(K,"qid",s.qid,"question",d)||s.question,C=U(K,"qid",s.qid,"help",d)||s.help,at=U(K,"qid",s.qid,"script",d)||s.script;if(A(at||"")){l.unsupported.push({code:"limesurvey-question-script",title:`${s.title||b} contains a question script`,detail:"Imported scripts are never executed or silently removed."});continue}if(Ae.test(C||"")||qe.test(C||"")||$e.test(C||"")){l.unsupported.push({code:"limesurvey-question-help-structure",title:`${s.title||b} contains dynamic or structured help content`,detail:"Executable code, expressions, media and interactive help are not imported."});continue}if(Be(C||"")){l.unsupported.push({code:"limesurvey-question-help",title:`${s.title||b} contains participant help text`,detail:"Question help text is not silently merged into or removed from the item wording."});continue}const j=A(ne??"")?G(ne,"Question text",s.title||b,l):null;if(s.type==="5"){if(!j){l.unsupported.push({code:"missing-visible-text",title:"Question text is empty",detail:`${s.title||b} does not contain participant-visible text.`});continue}const P={sourceId:s.title||b,name:s.title||`Item ${M.length+1}`,prompt:j,values:[1,2,3,4,5],labels:["1","2","3","4","5"]};M.push(P),l.imported.push(re(P))}else if(s.type==="L"||s.type==="!"){if(!j){l.unsupported.push({code:"missing-visible-text",title:"Question text is empty",detail:`${s.title||b} does not contain participant-visible text.`});continue}const P=We(s,D,Ee,d,l);if(!P)continue;const Z={sourceId:s.title||b,name:s.title||`Item ${M.length+1}`,prompt:j,...P};M.push(Z),l.imported.push(re(Z))}else if(s.type==="F"){const P=Re.filter(w=>w.parent_qid===s.qid).sort((w,X)=>(Number(w.question_order)||0)-(Number(X.question_order)||0));if(!P.length){l.unsupported.push({code:"limesurvey-array-without-rows",title:`${s.title||b} has no array row`,detail:"A LimeSurvey Array question must contain at least one explicit row before it can be converted."});continue}if(P.some(w=>w.relevance&&w.relevance!=="1"||w.other&&w.other!=="N"||w.scale_id&&w.scale_id!=="0")){l.unsupported.push({code:"limesurvey-array-row-behaviour",title:`${s.title||b} contains an unsupported array row`,detail:"Conditional, “Other” or secondary-scale array rows are not flattened."});continue}const Z=We(s,D,Ee,d,l);if(!Z)continue;P.length===1?I(l,{code:"limesurvey-single-row-array-expanded",title:"Single-row LimeSurvey Array questions were converted to rating items",detail:"Each source question contains one array row. Review the displayed item wording and response scale against LimeSurvey."}):I(l,{code:"limesurvey-array-expanded",title:"LimeSurvey Array rows were converted to separate rating items",detail:"The source array heading is combined with each visible row label when both contain text. Review the converted wording and order."});for(const w of P){const X=w.qid||w.title||`${b}-row`,xe=U(K,"qid",w.qid,"question",d)||w.question,de=U(K,"qid",w.qid,"help",d)||w.help,lt=U(K,"qid",w.qid,"script",d)||w.script;if(A(lt||"")||Ae.test(de||"")||qe.test(de||"")||$e.test(de||"")||Be(de||"")){l.unsupported.push({code:"limesurvey-array-row-content",title:`${w.title||X} contains unsupported row content`,detail:"Array-row scripts, dynamic content and help text are not imported."});continue}const ce=A(xe??"")?G(xe,"Array row text",w.title||X,l):null,Pe=j&&ce?`${j}: ${ce}`:j||ce;if(!Pe){l.unsupported.push({code:"missing-visible-text",title:"Array item text is empty",detail:`${w.title||X} and its parent question contain no participant-visible text.`});continue}const Le={sourceId:`${s.title||b}/${w.title||X}`,name:P.length===1&&!ce?s.title||`Item ${M.length+1}`:w.title||s.title||`Item ${M.length+1}`,prompt:Pe,values:[...Z.values],labels:[...Z.labels]};M.push(Le),l.imported.push(re(Le))}}else l.unsupported.push({code:"limesurvey-unsupported-question",title:`${s.title||b} uses unsupported LimeSurvey type ${s.type||"unknown"}`,detail:"Supported in this release: List (Radio), 5 Point Choice and reviewed Array rating rows."})}const Qe=a==="Question"?"":oe?.description||T.description||ie?.surveyls_description||ie?.surveyls_welcometext||"",st=A(Qe)?G(Qe,"Survey introduction","surveys_languagesettings",l):null,ot=et(L,`Imported from ${h}`,st??"Answer each imported item about the task that you have just completed.",Xe(d,"en"),M,l);return he(v,h,t,L,ot,l,{groupOptions:F,selectedGroupId:T.gid,ratingSetOptions:O,selectedRatingSetId:Y?.id})}function Nt(e,t){const i=t.toLowerCase().split(".").at(-1),n=e.trimStart();if(n.startsWith("{")&&/"SurveyElements"/.test(e))return"qualtrics-qsf";if(n.startsWith("<")&&/<LimeSurveyDocType>Survey</.test(e))return"limesurvey-lss";if(n.startsWith("<")&&/<LimeSurveyDocType>Group</.test(e))return"limesurvey-lsg";if(n.startsWith("<")&&/<LimeSurveyDocType>Question</.test(e))return"limesurvey-lsq";if(i==="qsf")return"qualtrics-qsf";if(i==="lss")return"limesurvey-lss";if(i==="lsg")return"limesurvey-lsg";if(i==="lsq")return"limesurvey-lsq";throw i==="lsa"?new Error("LimeSurvey LSA archives are not imported because they may contain responses, tokens and participant data. Export survey structure as LSS instead."):i==="lsl"?new Error("A LimeSurvey LSL file contains only a reusable label set, not a questionnaire. Export the containing question as LSQ, group as LSG or survey as LSS."):i==="csv"||i==="tsv"||i==="xls"||i==="xlsx"?new Error("CSV, TSV and spreadsheet files are ambiguous table formats used for response data or platform-specific bulk authoring. Import the file into its source platform, review it there, then export Qualtrics QSF or LimeSurvey LSS, LSG or LSQ."):i==="sav"||i==="spss"||i==="vv"?new Error("This is a response-data format, not a reusable questionnaire definition. Export Qualtrics QSF or LimeSurvey LSS, LSG or LSQ from the source questionnaire."):i==="txt"||i==="doc"||i==="docx"||i==="rtf"||i==="odt"?new Error("Text and word-processing files may be manually prepared authoring files or readable exports; they are not an unambiguous native structure export. Import the file into Qualtrics or LimeSurvey first, review it there, then export QSF, LSS, LSG or LSQ."):i==="pdf"||i==="html"||i==="htm"||i==="xml"||i==="zip"?new Error("This print, generic XML or archive format is not an unambiguous native questionnaire structure export. Export Qualtrics QSF or LimeSurvey LSS, LSG or LSQ."):i==="json"?new Error("This JSON file is not a Qualtrics QSF. If it is an AQP questionnaire definition, use the separate “Reuse an AQP questionnaire definition” route; otherwise export Qualtrics QSF."):new Error("Choose a Qualtrics .qsf file or a LimeSurvey .lss, .lsg or .lsq file.")}function we(e,t,i="auto",n,r){const o=new TextEncoder().encode(e).length;if(!e.trim())throw new Error("The selected questionnaire export is empty.");if(o>$t)throw new Error("The selected questionnaire export is larger than the 2 MB review limit.");const a=Nt(e,t);if(i!=="auto"&&i!==a){const v=a==="qualtrics-qsf"?"Qualtrics QSF":a==="limesurvey-lss"?"LimeSurvey LSS":a==="limesurvey-lsg"?"LimeSurvey LSG":"LimeSurvey LSQ";throw new Error(`The selected file looks like ${v}, not the chosen format.`)}return a==="qualtrics-qsf"?Qt(e,t):kt(e,t,n,r)}var Dt=Object.defineProperty,Ot=Object.getOwnPropertyDescriptor,f=(e,t,i,n)=>{for(var r=n>1?void 0:n?Ot(t,i):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(r=(n?a(t,i,r):a(r))||r);return n&&r&&Dt(t,i,r),r};const Mt=_e.trim().split(/\r?\n/).filter(Boolean).length,ee=Ie.match(/var bridgeBuild = '([^']+)'/)?.[1]??"unidentified",Je=[{key:"source",title:"Choose the questionnaire source"},{key:"scoring",title:"Confirm the questionnaire and scoring"},{key:"study",title:"Enter study details"},{key:"support",title:"Set participant support"},{key:"collection",title:"Choose result collection"},{key:"review",title:"Review and generate"}],He=[{key:"source",title:"Choose the questionnaire source"},{key:"upload",title:"Upload the file and choose the relevant part"},{key:"questions",title:"Review the questions"},{key:"answers",title:"Review answer choices and stored values"},{key:"warnings",title:"Resolve import warnings"},{key:"scoring",title:"Confirm the scoring rule"},{key:"study",title:"Enter study details"},{key:"support",title:"Set participant support"},{key:"collection",title:"Choose result collection"},{key:"review",title:"Review and generate"}],Se="accessible-questionnaire-v0.8-conductor-draft";function Ft(e){const t=Array.isArray(e)?e:[e];return t.length>0&&t.some(i=>{if(!i||typeof i!="object")return!1;const n=i;return"study"in n&&"responses"in n&&"result"in n})}function jt(e){const t="PASTE_THE_GENERATED_PARTICIPANT_PAGE_URL_HERE";if(!e||e.includes(t))throw new Error("A generated participant URL is required for the Qualtrics question HTML.");const i=e.replace(/&/g,"&amp;").replace(/"/g,"&quot;");return St.trim().replace(t,i)}function Ut(e){const t=e?["Questionnaire:","${e://Field/__js_AQP_INSTRUMENT_NAME}","","${e://Field/__js_AQP_SCORE_NAME}:","${e://Field/__js_AQP_PRIMARY_SCORE}"].join(`
`):"";return wt.replace("{{OPTIONAL_SCORE_BLOCK}}",t).replace(/\n{3,}/g,`

`).trim()}let m=class extends pt{constructor(){super(...arguments),this.setupRoute="ready-made",this.wizardStepIndex=0,this.scoringConfirmed=!1,this.importWarningsAcknowledged=!1,this.instrumentId=mt,this.customDefinition=null,this.customDraft=je(),this.customBuilderOpen=!1,this.platformImportSource="auto",this.platformImportReview=null,this.platformImportConfirmed=!1,this.platformImportSelectedGroupId="",this.platformImportSelectedRatingSetId="",this.platformImportContents="",this.platformImportFileName="",this.studyId="",this.studyTitle="",this.taskLabel="",this.showScoreToParticipant=!1,this.showSimpleLanguage=!1,this.answerMode="standard",this.largeText=!1,this.audioGuidance=!1,this.recoveryEnabled=!0,this.participantAdjustmentPolicy="participant-choice",this.voiceInputAvailable=!0,this.gazeInputAvailable=!1,this.collectionMode="local",this.qualtricsSurveyUrl="",this.generatedConfig=null,this.participantUrl="",this.message="",this.definitionConfirmation="",this.configurationConfirmation="",this.errorMessage="",this.completedResults=[],this.draftRestored=!1,this.handleWizardPopState=e=>{const t=Number(e.state?.aqpConductorStep);!Number.isInteger(t)||t<0||t>=this.wizardSteps.length||(this.wizardStepIndex=t,this.errorMessage="",this.focusWizardHeading())},this.continueWizard=()=>{this.errorMessage="";const e=this.wizardStep.key;try{if(e==="upload"){const i=this.platformImportReview;if(!i)throw new Error("Choose and review a questionnaire export before continuing.");if(i.requiresGroupSelection)throw new Error("Choose the LimeSurvey questionnaire group before continuing.");if(i.requiresRatingSetSelection)throw new Error("Choose the compatible LimeSurvey rating set before continuing.");if(!i.canConvert||!i.draft)throw new Error("This export contains unsupported content. Correct the source and review a new export before continuing.")}if(e==="warnings"&&!this.importWarningsAcknowledged)throw new Error("Acknowledge the listed import findings before continuing.");if(e==="scoring"){if(this.setupRoute==="imported"){if(!this.platformImportConfirmed)throw new Error("Confirm the scoring rule and imported values against the source before continuing.");if(this.usePlatformImport(),this.customDefinition?.id!==this.instrumentId)throw new Error("The reviewed questionnaire could not be activated. Check the scoring fields and try again.")}else if(!this.scoringConfirmed)throw new Error("Confirm that the selected questionnaire and scoring rule match the study protocol.")}e==="study"&&this.validateStudyDetails(),e==="collection"&&this.currentCollectionConfig();const t=Math.min(this.wizardStepIndex+1,this.wizardSteps.length-1);if(t===this.wizardStepIndex)return;this.wizardStepIndex=t,window.history.pushState({...window.history.state??{},aqpConductorStep:t},"",window.location.href),this.message=`Step ${t+1} of ${this.wizardSteps.length}: ${this.wizardSteps[t].title}.`,this.focusWizardHeading()}catch(t){this.showError(t instanceof Error?t.message:"This step is incomplete.")}},this.previousWizard=()=>{if(this.wizardStepIndex===0)return;const e=this.wizardStepIndex-1;this.wizardStepIndex=e,window.history.pushState({...window.history.state??{},aqpConductorStep:e},"",window.location.href),this.errorMessage="",this.message=`Step ${e+1} of ${this.wizardSteps.length}: ${this.wizardSteps[e].title}.`,this.focusWizardHeading()},this.selectInstrument=e=>{const t=e.currentTarget.value,i=this.availableDefinitions.find(n=>n.id===t)??null;i&&(this.instrumentId=t,i.supports.simplerExplanations||(this.showSimpleLanguage=!1),i.supports.smileyLandmarks||(this.answerMode="standard"),this.scoringConfirmed=!1,this.generatedConfig=null,this.participantUrl="",this.definitionConfirmation=`${i.name} ${i.version} selected. Complete the study details, then generate a new configuration.`,this.configurationConfirmation="",this.message=`${i.name} selected. Generate a new configuration before testing.`)},this.importPlatformQuestionnaire=async e=>{const t=e.currentTarget,i=t.files?.[0];if(i){this.errorMessage="",this.definitionConfirmation="",this.platformImportReview=null,this.platformImportConfirmed=!1,this.importWarningsAcknowledged=!1;try{const n=await i.text();this.platformImportContents=n,this.platformImportFileName=i.name,this.platformImportSelectedGroupId="",this.platformImportSelectedRatingSetId="";const r=we(n,i.name,this.platformImportSource);this.platformImportReview=r,this.platformImportSelectedGroupId=r.selectedGroupId??"",r.draft&&(this.customDraft=structuredClone(r.draft)),this.message=r.requiresGroupSelection?"Choose one LimeSurvey questionnaire group to review.":r.requiresRatingSetSelection?"Choose one compatible LimeSurvey rating set to review.":r.canConvert?"Import review ready. Check every section and confirm scoring before conversion.":"Import review found unsupported content. No partial questionnaire was created.",this.revealConductorResult("#platform-import-review")}catch(n){this.showError(n instanceof Error?n.message:"The questionnaire export could not be reviewed.")}finally{t.value=""}}},this.reviewSelectedLimeSurveyGroup=()=>{if(!(!this.platformImportContents||!this.platformImportFileName||!this.platformImportSelectedGroupId)){this.errorMessage="",this.definitionConfirmation="",this.platformImportConfirmed=!1,this.importWarningsAcknowledged=!1;try{const e=we(this.platformImportContents,this.platformImportFileName,this.platformImportSource,this.platformImportSelectedGroupId);this.platformImportReview=e,this.platformImportSelectedRatingSetId="",e.draft&&(this.customDraft=structuredClone(e.draft)),this.message=e.requiresRatingSetSelection?"Choose one compatible rating set in the selected LimeSurvey group.":e.canConvert?"Selected group review ready. Check every section and confirm scoring before conversion.":"The selected group contains unsupported content. No partial questionnaire was created.",this.revealConductorResult("#platform-import-review")}catch(e){this.showError(e instanceof Error?e.message:"The selected LimeSurvey group could not be reviewed.")}}},this.reviewSelectedLimeSurveyRatingSet=()=>{if(!(!this.platformImportContents||!this.platformImportFileName||!this.platformImportSelectedGroupId||!this.platformImportSelectedRatingSetId)){this.errorMessage="",this.definitionConfirmation="",this.platformImportConfirmed=!1,this.importWarningsAcknowledged=!1;try{const e=we(this.platformImportContents,this.platformImportFileName,this.platformImportSource,this.platformImportSelectedGroupId,this.platformImportSelectedRatingSetId);this.platformImportReview=e,e.draft&&(this.customDraft=structuredClone(e.draft)),this.message=e.canConvert?"Selected rating-set review ready. Check every section and confirm scoring before conversion.":"The selected rating set contains unsupported content. No partial questionnaire was created.",this.revealConductorResult("#platform-import-review")}catch(e){this.showError(e instanceof Error?e.message:"The selected LimeSurvey rating set could not be reviewed.")}}},this.usePlatformImport=()=>{const e=this.platformImportReview;if(!(!e?.canConvert||!e.draft||!this.platformImportConfirmed)){this.errorMessage="",this.definitionConfirmation="";try{const t=Ue(this.customDraft);this.activateCustomDefinition(t,"imported")}catch(t){this.showError(t instanceof Error?t.message:"The reviewed questionnaire could not be converted.")}}},this.addCustomItem=()=>{this.customDraft.items.length>=z||(this.customDraft={...this.customDraft,items:[...this.customDraft.items,fe({name:`Item ${this.customDraft.items.length+1}`})]})},this.useCustomDraft=()=>{this.errorMessage="",this.definitionConfirmation="";try{this.activateCustomDefinition(Ue(this.customDraft),"validated")}catch(e){this.showError(e instanceof Error?e.message:"The custom questionnaire could not be validated.")}},this.importCustomDefinition=async e=>{const t=e.currentTarget,i=t.files?.[0];if(i){this.errorMessage="",this.definitionConfirmation="";try{const n=Ye(JSON.parse(await i.text()));this.activateCustomDefinition(n,"imported")}catch(n){this.showError(n instanceof Error?n.message:"The questionnaire definition file could not be read.")}finally{t.value=""}}},this.downloadCustomDefinition=()=>{this.customDefinition&&pe(At(this.customDefinition),JSON.stringify(this.customDefinition,null,2),"application/json")},this.resetCustomDraft=()=>{this.customDraft=je(),this.platformImportReview=null,this.platformImportConfirmed=!1,this.importWarningsAcknowledged=!1,this.platformImportSelectedGroupId="",this.platformImportSelectedRatingSetId="",this.platformImportContents="",this.platformImportFileName="",this.message="Custom questionnaire builder fields reset. The selected questionnaire is unchanged until you validate a new definition."},this.generateParticipantLink=()=>{this.errorMessage="",this.configurationConfirmation="";try{const e=Ne({instrumentId:this.instrumentId,...this.customDefinition?.id===this.instrumentId?{questionnaireDefinition:this.customDefinition}:{},studyId:this.studyId,studyTitle:this.studyTitle,taskLabel:this.taskLabel,showScoreToParticipant:this.showScoreToParticipant,support:this.currentSupportConfig(),collection:this.currentCollectionConfig()});this.useConfiguration(e),this.configurationConfirmation="Participant link and configuration generated. The ready-to-use files and link are shown below.",this.message="",this.revealConductorResult("#configuration-ready-panel")}catch(e){this.showError(e instanceof Error?e.message:"The study configuration could not be generated.")}},this.copyParticipantLink=async()=>{this.participantUrl&&await this.copySetupAsset(this.participantUrl,"participant link")},this.copySetupAsset=async(e,t)=>{try{if(!navigator.clipboard?.writeText)throw new Error("Clipboard API unavailable.");await navigator.clipboard.writeText(e),this.message=`${t.charAt(0).toUpperCase()}${t.slice(1)} copied.`}catch{this.message=`Automatic copy was unavailable. Select and copy the ${t} from its text box.`}},this.downloadConfiguration=()=>{this.generatedConfig&&pe(`${this.generatedConfig.studyId}-${this.generatedConfig.configId}.json`,JSON.stringify(this.generatedConfig,null,2),"application/json")},this.importConfiguration=async e=>{const t=e.currentTarget,i=t.files?.[0];if(i){this.errorMessage="",this.configurationConfirmation="";try{const n=JSON.parse(await i.text()),r=De(n);if(!r)throw Ft(n)?new Error("This is a completed result file, not a study configuration. Import the JSON downloaded from Configuration ready."):new Error("This is not a valid Version 0.8 study configuration or supported Version 0.7 configuration.");this.useConfiguration(r),this.configurationConfirmation="Configuration imported and participant link reproduced. The configuration ID and files are shown below.",this.message="",this.revealConductorResult("#configuration-ready-panel")}catch(n){this.showError(n instanceof Error?n.message:"The configuration file could not be read.")}finally{t.value=""}}},this.refreshResults=()=>{this.completedResults=ht()},this.exportResultsJson=()=>{this.completedResults.length&&pe(`accessible-questionnaire-results-${new Date().toISOString().slice(0,10)}.json`,JSON.stringify(this.completedResults,null,2),"application/json")},this.exportResultsCsv=()=>{this.completedResults.length&&pe(`accessible-questionnaire-results-${new Date().toISOString().slice(0,10)}.csv`,`\uFEFF${ft(this.completedResults)}`,"text/csv")},this.eraseResults=()=>{window.confirm("Erase every completed questionnaire record stored by this site in this browser? Confirm only after checking the exported files.")&&(gt(),this.refreshResults(),this.message="Local completed records erased.")}}connectedCallback(){super.connectedCallback(),this.restoreConductorDraft(),this.refreshResults(),window.addEventListener("storage",this.refreshResults),window.addEventListener("popstate",this.handleWizardPopState),window.history.replaceState({...window.history.state??{},aqpConductorStep:this.wizardStepIndex},"",window.location.href)}disconnectedCallback(){window.removeEventListener("storage",this.refreshResults),window.removeEventListener("popstate",this.handleWizardPopState),super.disconnectedCallback()}updated(){this.draftRestored&&this.persistConductorDraft()}createRenderRoot(){return this}get definition(){return yt(this.instrumentId,this.customDefinition??void 0)}get availableDefinitions(){return this.customDefinition?[...Oe,this.customDefinition]:Oe}get wizardSteps(){return this.setupRoute==="imported"?He:Je}get wizardStep(){return this.wizardSteps[Math.min(this.wizardStepIndex,this.wizardSteps.length-1)]}selectSetupRoute(e){this.setupRoute!==e&&(this.setupRoute=e,this.wizardStepIndex=0,this.errorMessage="",this.scoringConfirmed=!1,this.importWarningsAcknowledged=!1,this.generatedConfig=null,this.participantUrl="",this.replaceWizardHistory())}replaceWizardHistory(){window.history.replaceState({...window.history.state??{},aqpConductorStep:this.wizardStepIndex},"",window.location.href)}focusWizardHeading(){this.updateComplete.then(()=>{const e=this.querySelector("#conductor-step-heading");e&&ve(e,{block:"start"})})}persistConductorDraft(){try{window.sessionStorage.setItem(Se,JSON.stringify({setupRoute:this.setupRoute,wizardStepIndex:this.wizardStepIndex,scoringConfirmed:this.scoringConfirmed,importWarningsAcknowledged:this.importWarningsAcknowledged,instrumentId:this.instrumentId,customDefinition:this.customDefinition,customDraft:this.customDraft,platformImportSource:this.platformImportSource,platformImportReview:this.platformImportReview,platformImportConfirmed:this.platformImportConfirmed,platformImportSelectedGroupId:this.platformImportSelectedGroupId,platformImportSelectedRatingSetId:this.platformImportSelectedRatingSetId,studyId:this.studyId,studyTitle:this.studyTitle,taskLabel:this.taskLabel,showScoreToParticipant:this.showScoreToParticipant,showSimpleLanguage:this.showSimpleLanguage,answerMode:this.answerMode,largeText:this.largeText,audioGuidance:this.audioGuidance,recoveryEnabled:this.recoveryEnabled,participantAdjustmentPolicy:this.participantAdjustmentPolicy,voiceInputAvailable:this.voiceInputAvailable,gazeInputAvailable:this.gazeInputAvailable,collectionMode:this.collectionMode,qualtricsSurveyUrl:this.qualtricsSurveyUrl,generatedConfig:this.generatedConfig}))}catch{}}restoreConductorDraft(){try{const e=window.sessionStorage.getItem(Se);if(!e){this.draftRestored=!0;return}const t=JSON.parse(e),i=t.setupRoute==="imported"?"imported":"ready-made";this.setupRoute=i;const n=i==="imported"?He:Je,r=Number(t.wizardStepIndex);this.wizardStepIndex=Number.isInteger(r)&&r>=0&&r<n.length?r:0,this.scoringConfirmed=t.scoringConfirmed===!0,this.importWarningsAcknowledged=t.importWarningsAcknowledged===!0,typeof t.instrumentId=="string"&&(this.instrumentId=t.instrumentId),t.customDefinition&&typeof t.customDefinition=="object"&&(this.customDefinition=t.customDefinition),t.customDraft&&typeof t.customDraft=="object"&&(this.customDraft=t.customDraft),typeof t.platformImportSource=="string"&&(this.platformImportSource=t.platformImportSource),t.platformImportReview&&typeof t.platformImportReview=="object"&&(this.platformImportReview=t.platformImportReview),this.platformImportConfirmed=t.platformImportConfirmed===!0,typeof t.platformImportSelectedGroupId=="string"&&(this.platformImportSelectedGroupId=t.platformImportSelectedGroupId),typeof t.platformImportSelectedRatingSetId=="string"&&(this.platformImportSelectedRatingSetId=t.platformImportSelectedRatingSetId),typeof t.studyId=="string"&&(this.studyId=t.studyId),typeof t.studyTitle=="string"&&(this.studyTitle=t.studyTitle),typeof t.taskLabel=="string"&&(this.taskLabel=t.taskLabel),this.showScoreToParticipant=t.showScoreToParticipant===!0,this.showSimpleLanguage=t.showSimpleLanguage===!0,this.answerMode=t.answerMode==="smiley"?"smiley":"standard",this.largeText=t.largeText===!0,this.audioGuidance=t.audioGuidance===!0,this.recoveryEnabled=t.recoveryEnabled!==!1,(t.participantAdjustmentPolicy==="locked"||t.participantAdjustmentPolicy==="presentation-only"||t.participantAdjustmentPolicy==="participant-choice")&&(this.participantAdjustmentPolicy=t.participantAdjustmentPolicy),this.voiceInputAvailable=t.voiceInputAvailable!==!1,this.gazeInputAvailable=t.gazeInputAvailable===!0,this.collectionMode=t.collectionMode==="qualtrics"?"qualtrics":"local",typeof t.qualtricsSurveyUrl=="string"&&(this.qualtricsSurveyUrl=t.qualtricsSurveyUrl);const o=t.generatedConfig?De(t.generatedConfig):null;o&&this.useConfiguration(o),i==="imported"&&(this.platformImportReview?.requiresGroupSelection||this.platformImportReview?.requiresRatingSetSelection)&&!this.platformImportContents&&(this.wizardStepIndex=1,this.platformImportReview=null,this.platformImportSelectedGroupId="",this.platformImportSelectedRatingSetId="",this.message="Select the source file again to continue choosing its LimeSurvey group or rating set.")}catch{window.sessionStorage.removeItem(Se)}finally{this.draftRestored=!0}}validateStudyDetails(){Ne({instrumentId:this.instrumentId,...this.customDefinition?.id===this.instrumentId?{questionnaireDefinition:this.customDefinition}:{},studyId:this.studyId,studyTitle:this.studyTitle,taskLabel:this.taskLabel,showScoreToParticipant:this.showScoreToParticipant,support:this.currentSupportConfig(),collection:{mode:"local"}})}render(){return u`
      <a class="skip-link" href="#conductor-main">Skip to study setup</a>
      <main class="app-shell conductor-shell" id="conductor-main">
        <header class="app-header">
          <p class="eyebrow">
            Study conductor · Version ${be} · Qualtrics package ${ee}
          </p>
        ...
        ${this.errorMessage?u`<div class="error-summary" role="alert" tabindex="-1" id="conductor-error">
        ...
        >
          ...
          ${this.wizardStep.key==="source"?u`
                ...
                ${this.setupRoute==="imported"?u`<p class="support-boundary">
          ...
          <div class="form-grid" ?hidden=${this.wizardStep.key!=="source"||this.setupRoute!=="ready-made"}>
            <label class="full-width">
              ...
              <select @change=${this.selectInstrument}>
                ${this.availableDefinitions.map(e=>u`<option
                    value=${e.id}
                    .selected=${e.id===this.instrumentId}
                  >
                    ${e.name} · ${e.version}${Ve(e.id)?"":" · researcher supplied"}
                  </option>`)}
              </select>
            </label>
            <aside
            ...
            >
              ${this.definitionConfirmation?u`<p
              ...
              <span>
                ...
                ${me(this.definition).length}
                ${this.definition.scale.type.replace("-"," ")} response values,
                ${vt(this.definition).length} comparisons,
              ...
              ${this.definition.source.url?u`<a href=${this.definition.source.url} target="_blank" rel="noopener">
                    Instrument source: ${this.definition.source.label}
                  </a>`:u`<span>Instrument source: ${this.definition.source.label}</span>`}
            </aside>
        ...
        >
          ...
          <div class="config-grid">
            ${this.definition.supports.simplerExplanations?this.booleanOption("Show simpler explanations from the start",this.showSimpleLanguage,e=>{this.showSimpleLanguage=e}):u`<aside class="boundary-note">
          ...
          ${this.definition.supports.smileyLandmarks?u`<fieldset class="answer-mode-control conductor-answer-mode">
                ...
                <label>
                  ...
                  <span>
                    <strong>Standard ${me(this.definition).length}-value scale</strong>
              ...
              </fieldset>`:u`<p class="support-boundary">
                ${this.definition.shortName} uses its standard ${me(this.definition).length}-value
        ...
        >
          ...
          ${this.collectionMode==="qualtrics"?u`<label class="full-width">
        ...
        >
          ...
          ${this.generatedConfig?u`<div
                ...
                tabindex="-1"
              >
                ${this.configurationConfirmation?u`<p
                      class="success-message"
                ...
                <div class="button-row compact">
                  ...
                  ${this.generatedConfig.collection.mode==="local"?u`<a class="secondary-button link-button" href=${this.participantUrl} target="_blank" rel="noopener">Open participant page</a>`:$}
        ...
        >
          ...
          ${this.completedResults.length?u`
              ...
              `:u`<p>After a configured questionnaire is completed in this same browser, its pseudonymous record will appear here.</p>`}
        </section>
        ...
        >
          ...
          <p>
            Version ${be} includes a Qualtrics parent bridge. The participant page sends a complete record only to the
    ...
    `}renderQuestionnaireReviewStep(){const e=this.wizardStep.key;if(!["upload","questions","answers","warnings","scoring"].includes(e))return $;if(e==="scoring"&&this.setupRoute==="ready-made")return u`
        <section class="panel conductor-panel" aria-labelledby="questionnaire-scoring-heading">
          ...
          <dl class="study-details">
            ...
            <div><dt>Response values</dt><dd>${me(this.definition).join(", ")}</dd></div>
      ...
      `;const t=this.platformImportReview;if(e==="upload")return u`
        <section class="panel conductor-panel" aria-labelledby="questionnaire-upload-heading">
          ...
          ${t&&!t.requiresGroupSelection&&!t.requiresRatingSetSelection?u`<aside class=${`definition-summary${t.canConvert?" success-confirmation":""}`}>
      ...
      `;if(!t?.draft)return u`<section class="panel conductor-panel">
        ...
        <section class="panel conductor-panel" aria-labelledby="import-question-review-heading">
          ...
          <ol class="wizard-review-list">
            ${this.customDraft.items.map(i=>u`<li>
      ...
      `;if(e==="answers"){const i=[];for(let n=this.customDraft.minimum;n<=this.customDraft.maximum;n+=this.customDraft.step)i.push(n);return u`
        <section class="panel conductor-panel" aria-labelledby="import-answer-review-heading">
          ...
          <ol class="wizard-review-list compact-review-list">
            ${this.customDraft.items.map(n=>u`<li>
              <strong>${n.name}</strong>
              <span>${n.lowAnchor} (${this.customDraft.minimum}) → ${n.highAnchor} (${this.customDraft.maximum})</span>
              ${n.responseLabels?u`<small>Visible labels: ${Object.entries(n.responseLabels).map(([r,o])=>`${r} = ${o}`).join("; ")}</small>`:u`<small>Intermediate positions use their stored number.</small>`}
            </li>`)}
          </ol>
        </section>
      `}return e==="warnings"?u`
      ...
      <section class="panel conductor-panel" aria-labelledby="import-scoring-heading">
        ...
        <fieldset class="platform-import-reverse-items">
          ...
          ${this.customDraft.items.map((i,n)=>u`<label>
            <input
    ...
    `}renderImportFindingList(e,t,i,n){return u`<section class=${`platform-import-finding ${t}`}>
      <h3>${e} (${i.length})</h3>
      ${i.length?u`<ul>${i.map(r=>u`<li>
            <strong>${r.title}</strong><span>${r.detail}</span>
          </li>`)}</ul>`:u`<p>${n}</p>`}
    </section>`}renderConfigurationSummary(){return u`
      <dl class="study-details configuration-review-summary">
        ...
        <div><dt>Collection</dt><dd>${this.collectionMode==="qualtrics"?`Qualtrics: ${Me(this.qualtricsSurveyUrl)??"invalid URL"}`:"This browser only"}</dd></div>
      </dl>
    ...
    `}renderWizardNavigation(){const e=this.wizardStep.key==="review",t=this.wizardStep.key==="scoring"&&this.setupRoute==="imported"?"Convert and continue":this.wizardStepIndex===this.wizardSteps.length-2?"Continue to review":"Continue";return u`
      <nav class="wizard-navigation button-row" aria-label="Researcher setup steps">
        ...
        >Back</button>
        ${e?u`<span class="support-boundary">This is the final setup step. Generate only after checking the summary.</span>`:u`<button
              class="primary-button large-answer-button"
              type="button"
              @click=${this.continueWizard}
            >${t}</button>`}
      </nav>
    `}renderCustomQuestionnaireBuilder(e=!0){return u`
      <section
      ...
      >
        ...
        >
          ...
          <p>
            ...
            1–${z} required single-choice items that
        ...
        <fieldset class="custom-items">
          ...
          <button
            class="secondary-button"
            type="button"
            ?disabled=${this.customDraft.items.length>=z}
    ...
    `}renderPlatformQuestionnaireImport(e=!0){const t=this.platformImportReview;return u`
      <section
    ...
    `}renderPlatformQuestionnaireReview(e){const t=(i,n,r,o)=>u`
    ...
    `;return e.requiresGroupSelection&&e.groupOptions?.length?u`
        <section
      ...
      `:e.requiresRatingSetSelection&&e.ratingSetOptions?.length?u`
        <section
          class="platform-import-review import-selection"
          id="platform-import-review"
          tabindex="-1"
        ...
        ${e.canConvert&&e.draft?u`
              <fieldset class="platform-import-confirmation">
                ...
                <fieldset class="platform-import-reverse-items">
                  ...
                  ${this.customDraft.items.map((i,n)=>u`
                    <label>
                      <input
                        data-platform-import-reverse=${n}
                        type="checkbox"
    ...
    `}renderCustomQuestionnaireItem(e,t){return u`
    ...
    `}updateCustomDraft(e,t){this.customDraft={...this.customDraft,[e]:t},this.platformImportReview&&(this.platformImportConfirmed=!1),this.platformImportReview&&(this.importWarningsAcknowledged=!1)}updateCustomItem(e,t,i){this.customDraft={...this.customDraft,items:this.customDraft.items.map((n,r)=>r===e?{...n,[t]:i}:n)},this.platformImportReview&&(this.platformImportConfirmed=!1),this.platformImportReview&&(this.importWarningsAcknowledged=!1)}removeCustomItem(e){this.customDraft.items.length!==1&&(this.customDraft={...this.customDraft,items:this.customDraft.items.filter((t,i)=>i!==e)})}activateCustomDefinition(e,t){this.customDefinition=e,this.instrumentId=e.id,e.supports.simplerExplanations||(this.showSimpleLanguage=!1),this.answerMode="standard",this.generatedConfig=null,this.participantUrl="";const i=t==="imported"?"imported, validated and selected":"validated and selected";this.definitionConfirmation=`${e.name} ${e.version} ${i}. Complete the study details, then generate a new configuration.`,this.configurationConfirmation="",this.message="",this.revealConductorResult("#selected-questionnaire-summary")}booleanOption(e,t,i,n=""){return u`<label class="toggle-card conductor-toggle">
      ...
      <div class="qualtrics-setup" role="region" aria-labelledby="qualtrics-setup-heading">
        ...
        <p>
          ...
          platform ${be}; Qualtrics bridge ${ee}.
        ...
        <ol class="qualtrics-install-steps">
          ...
          <li>
            ...
            <label for="qualtrics-embedded-fields">
              <strong>${Mt} Embedded Data field names</strong>
            </label>
            <textarea
            ...
            <button
              class="secondary-button"
              type="button"
              @click=${()=>this.copySetupAsset(_e.trim(),"Embedded Data field list")}
            >
          ...
          <li>
            ...
            <button
              class="secondary-button"
              type="button"
              @click=${()=>this.copySetupAsset(Ie.trim(),"question JavaScript")}
            >
    ...
    `}showError(e){this.errorMessage=e,this.updateComplete.then(()=>{const t=this.querySelector("#conductor-error");t&&ve(t)})}revealConductorResult(e){this.updateComplete.then(()=>{const t=this.querySelector(e);t&&ve(t,{block:"start"})})}};f([g()],m.prototype,"setupRoute",2);f([g()],m.prototype,"wizardStepIndex",2);f([g()],m.prototype,"scoringConfirmed",2);f([g()],m.prototype,"importWarningsAcknowledged",2);f([g()],m.prototype,"instrumentId",2);f([g()],m.prototype,"customDefinition",2);f([g()],m.prototype,"customDraft",2);f([g()],m.prototype,"customBuilderOpen",2);f([g()],m.prototype,"platformImportSource",2);f([g()],m.prototype,"platformImportReview",2);f([g()],m.prototype,"platformImportConfirmed",2);f([g()],m.prototype,"platformImportSelectedGroupId",2);f([g()],m.prototype,"platformImportSelectedRatingSetId",2);f([g()],m.prototype,"studyId",2);f([g()],m.prototype,"studyTitle",2);f([g()],m.prototype,"taskLabel",2);f([g()],m.prototype,"showScoreToParticipant",2);f([g()],m.prototype,"showSimpleLanguage",2);f([g()],m.prototype,"answerMode",2);f([g()],m.prototype,"largeText",2);f([g()],m.prototype,"audioGuidance",2);f([g()],m.prototype,"recoveryEnabled",2);f([g()],m.prototype,"participantAdjustmentPolicy",2);f([g()],m.prototype,"voiceInputAvailable",2);f([g()],m.prototype,"gazeInputAvailable",2);f([g()],m.prototype,"collectionMode",2);f([g()],m.prototype,"qualtricsSurveyUrl",2);f([g()],m.prototype,"generatedConfig",2);f([g()],m.prototype,"participantUrl",2);f([g()],m.prototype,"message",2);f([g()],m.prototype,"definitionConfirmation",2);f([g()],m.prototype,"configurationConfirmation",2);f([g()],m.prototype,"errorMessage",2);f([g()],m.prototype,"completedResults",2);m=f([ct("study-conductor-app")],m);
