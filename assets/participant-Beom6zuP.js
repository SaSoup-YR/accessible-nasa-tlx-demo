    ...
    `}renderSmileyResponse(e,t){return r`
      <fieldset class="smiley-response">
        ...
        <div class="smiley-grid">
          ${I.map(({value:s,cue:i})=>{const a=`smiley-${e.id}-${s}`;return r`
              <label
                class="smiley-option"
                for=${a}
                data-gaze-target
