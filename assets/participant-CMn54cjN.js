import{r as P,s as U,a as d,t as j,i as K,g as L,D as x,v as y,b as Y,c as J,d as Z,f as I,e as X,h as _,j as ee,P as G,A as c,k as n,l as O,m as q,n as te,o as se,p as ie,q as ae}from"./study-DO0I31Q8.js";const ne="accessible-questionnaire:qualtrics-submit:v2",re="accessible-questionnaire:qualtrics-receipt:v2",oe="accessible-questionnaire:qualtrics-resize:v2",le="accessible-questionnaire:qualtrics-reveal:v2",de="accessible-questionnaire:qualtrics-parent-ready:v2",ce="accessible-questionnaire:qualtrics-child-ready:v2";function ue(e=window){const t=e.accessibleQuestionnaireResultSink??e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function he(e,t=window){if(e.collection.mode!=="qualtrics")return null;const s=me(e.collection.parentOrigin,t);return t.accessibleQuestionnaireResultSink=s,t.accessibleNasaTlxResultSink=s,pe(e.collection.parentOrigin,t),s}function pe(e,t=window){const s=t.ResizeObserver,i=t.MutationObserver;if(t.parent===t)return null;let a=null,r=!1;const u=()=>{const f=t.document.documentElement,A=t.document.body,M=Math.ceil(Math.max(f?.scrollHeight??0,f?.offsetHeight??0,A?.scrollHeight??0,A?.offsetHeight??0));M>0&&t.parent.postMessage({type:oe,height:M},e)},p=()=>{r||(r=!0,a=t.requestAnimationFrame(()=>{r=!1,a=null,u()}))},h=()=>{t.parent.postMessage({type:ce,protocolVersion:2},e),p()},g=f=>{if(f.source!==t.parent||f.origin!==e)return;f.data?.type===de&&h()};t.addEventListener("message",g),t.addEventListener("load",h),t.addEventListener("resize",p);const b=typeof s=="function"?new s(p):null;b&&t.document.documentElement&&b.observe(t.document.documentElement),b&&t.document.body&&b.observe(t.document.body);const m=typeof i=="function"?new i(p):null;m&&t.document.documentElement&&m.observe(t.document.documentElement,{childList:!0,subtree:!0,attributes:!0});const w=[0,100,500,1500,4e3].map(f=>t.setTimeout(h,f));return h(),{disconnect(){a!==null&&t.cancelAnimationFrame(a),r=!1,b?.disconnect(),m?.disconnect(),w.forEach(f=>t.clearTimeout(f)),t.removeEventListener("message",g),t.removeEventListener("load",h),t.removeEventListener("resize",p)}}}function ge(e,t,s=window){if(s.parent===s)return!1;const i=e.getBoundingClientRect(),a=i.top+(s.scrollY||s.pageYOffset||0);return!Number.isFinite(a)||!Number.isFinite(i.height)?!1:(s.parent.postMessage({type:le,offsetTop:a,targetHeight:Math.max(1,i.height)},t),!0)}function me(e,t=window,s=12e3){return{name:"UCL Qualtrics",submit(i){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):new Promise((a,r)=>{let u=!1;const p=b=>{u||(u=!0,t.clearTimeout(g),t.removeEventListener("message",h),b())},h=b=>{if(b.source!==t.parent||b.origin!==e)return;const m=b.data;if(!(!m||m.type!==re||m.submissionId!==i.submissionId)){if(m.accepted!==!0){p(()=>r(new Error(typeof m.error=="string"&&m.error?m.error:"Qualtrics did not accept the response.")));return}p(()=>a({accepted:!0,submissionId:i.submissionId,receiptId:typeof m.receiptId=="string"?m.receiptId:void 0}))}},g=t.setTimeout(()=>{p(()=>r(new Error("Qualtrics did not acknowledge the response in time.")))},s);t.addEventListener("message",h),t.parent.postMessage({type:ne,record:i},e)})}}}async function be(e,t,s=15e3){let i;const a=new Promise((u,p)=>{i=setTimeout(()=>p(new Error("The study platform did not confirm receipt in time.")),s)});let r;try{r=await Promise.race([t.submit(e),a])}finally{i!==void 0&&clearTimeout(i)}if(!r||r.accepted!==!0||r.submissionId!==e.submissionId||r.receiptId!==void 0&&typeof r.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return r}const Q=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),z=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]);for(const e of P){const t=String(e).split("").map(s=>[...z].find(([,i])=>i===s)?.[0]).filter(s=>!!s).join(" ");t&&Q.set(t,e)}const V=new Set([...z.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),E=/\b(?:not|no|cancel|neither|except|without|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:anything\s+but|other\s+than|don\s+t)\b/,fe={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function T(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function B(e){return E.test(T(e))}function W(e,t){const s=e.map(a=>a.trim()).filter(Boolean);if(s.length===0||B(s[0]))return null;const i=s.map((a,r)=>({transcript:a,value:t(a),index:r})).filter(a=>a.value!==null);return i.length===0||s.slice(0,i[0].index).some(B)||new Set(i.map(({value:a})=>a)).size!==1?null:{transcript:i[0].transcript,value:i[0].value}}function ye(e,t){const s=e.split(" ").filter(Boolean),i=[];for(const a of s)if(/^(?:100|[0-9]{1,2})$/.test(a)){const r=Number(a);i.push(t.includes(r)?r:null)}for(let a=0;a<s.length;){if(!V.has(s[a])){a+=1;continue}const r=[];for(;a<s.length&&V.has(s[a]);)r.push(s[a]),a+=1;const u=r.length===1&&z.has(r[0])?Number(z.get(r[0])):Q.get(r.join(" "));i.push(u!==void 0&&t.includes(u)?u:null)}return i}function D(e){return e?.map(t=>t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|")}function $(e,t){return e.find(s=>s.position===t)?.value}function ve(e,t,s){const i=/\b(middle|midpoint|centre|center)\b/.test(e),a=D(t.voiceLowAliases),r=D(t.voiceHighAliases);if(!a||!r||s.length!==5)return;const u=`(?:${a})`,p=`(?:${r})`,h=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${u}\\b`).test(e),g=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${p}\\b`).test(e),b=t.voiceLowAliases?.includes("low")===!0&&e==="hello",m=new RegExp(`\\b${u}\\b`).test(e)||b,w=new RegExp(`\\b${p}\\b`).test(e);if(h||g)return[i,h,g].filter(Boolean).length!==1||h&&w||g&&m?null:h?$(s,"closer-low")??null:$(s,"closer-high")??null;if([i,m,w].some(Boolean))return[i,m,w].filter(Boolean).length!==1?null:i?$(s,"middle")??null:m?$(s,"low")??null:$(s,"high")??null}function we(e,t,s=P,i=U){const a=T(e);if(!a||E.test(a))return null;const r=ye(a,s),u=ve(a,t,i);return r.length>0?r.length!==1||r[0]===null||u===null||u!==void 0&&u!==r[0]?null:r[0]:u??null}function $e(e,t){const s=T(e);if(!s||E.test(s))return null;const i=t.map(a=>{const r=typeof a=="string"?a:a.id;return(typeof a=="string"?fe[r]??[r.replace(/[-_]/g," ")]:[a.name.toLowerCase(),r.replace(/[-_]/g," ")]).some(p=>s===p||s.includes(p))?r:null}).filter(a=>!!a);return i.length===1?i[0]:null}function Se(e,t,s=P,i=U){return W(e,a=>we(a,t,s,i))}function Ce(e,t){return W(e,s=>$e(s,t))}const k="3.5.3",ze=`https://cdn.jsdelivr.net/npm/webgazer@${k}/dist/webgazer.js`,ke=`https://cdn.jsdelivr.net/npm/webgazer@${k}/dist/mediapipe/face_mesh`,Ae="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let S=null;function F(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function xe(e=document){return window.webgazer?Promise.resolve(window.webgazer):S||(S=new Promise((t,s)=>{const i=e.querySelector("#webgazer-loader"),a=i??e.createElement("script"),r=()=>{window.webgazer?t(window.webgazer):s(new Error("WebGazer loaded without exposing its browser API."))};a.addEventListener("load",r,{once:!0}),a.addEventListener("error",()=>{a.remove(),s(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),i||(a.id="webgazer-loader",a.src=ze,a.integrity=Ae,a.crossOrigin="anonymous",a.referrerPolicy="no-referrer",e.head.append(a))}).catch(t=>{throw S=null,t}),S)}class N{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,s){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=s,{progress:0,activated:!1};const i=Math.min(1,Math.max(0,(s-this.startedAt)/this.durationMs));return i>=1?(this.reset(),{progress:1,activated:!0}):{progress:i,activated:!1}}reset(){this.key=null,this.startedAt=0}}var Ie=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,l=(e,t,s,i)=>{for(var a=i>1?void 0:i?Re(t,s):t,r=e.length-1,u;r>=0;r--)(u=e[r])&&(a=(i?u(t,s,a):u(a))||a);return i&&a&&Ie(t,s,a),a};const C=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],v=3;function R(e){const t=_(e);for(let s=t.length-1;s>0;s-=1){const i=Math.floor(Math.random()*(s+1));[t[s],t[i]]=[t[i],t[s]]}return t}let o=class extends K{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=R(L(x)),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.configurationApplied=!1,this.gazeCandidateTracker=new N(1e3),this.gazeConfirmationTracker=new N(1200),this.repeatSavedSessionOffer=()=>{this.savedSession&&(this.readAloudUsed=!0,this.speakText(this.savedSessionOfferSpeech(this.savedSession)))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!y(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.recoveredCompletedRecord=null,y(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig&&(this.participantCode=this.participantCode.trim(),!y(this.participantCode))){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=this.dimensions.length-1)),this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.stage="ratings",this.ratingIndex=this.dimensions.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=Y(this.definition,this.ratings,this.pairResponses),this.submittedRecord=J({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?ue():null;if(this.completionSavedLocally=this.studyConfig?Z(this.submittedRecord):!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`,this.announceAutomatic(this.statusMessage);try{this.hostReceipt=await be(this.submittedRecord,e),this.completionSavedByHost=!0,this.hostSinkName=e.name}catch(t){this.hostSubmissionFailed=!0;const s=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${s} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("questionnaire-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInput(),this.clearError(),this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInput(),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=R(this.definition),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionSavedByHost=!1,this.hostSubmissionFailed=!1,this.hostSinkName="",this.hostReceipt=null,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=""),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!F(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await xe();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=ke,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<v-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<C.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=v,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.cancelGazeProposal(),this.resetGazeHover(),this.restoreWebGazerPreviewContainer(),this.releaseGazeResources(),this.gazeState="off",this.gazeMessage="Gaze input and camera stopped.",this.announceAutomatic(this.gazeMessage)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const s=this.dimensions[this.ratingIndex],i=e.value;this.selectRating(s.id,i,"voice"),t=this.answerMode==="smiley"&&this.smileyLandmarks.some(r=>r.value===i)?`smiley-${s.id}-${i}`:`rating-${s.id}-${i}`}else{const s=this.pairOrder[this.pairIndex],i=e.value;this.selectPair(s.id,i,"voice"),t=`${s.id}-${i}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&!this.savedSession&&this.recoveredCompletedRecord&&this.updateComplete.then(()=>{const e=this.querySelector("#completed-backup-heading");e&&I(e,{block:"start",onReveal:()=>this.requestParentReveal(e)})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.stopReading(!1),this.releaseRecognition(),this.stopGazeInput(),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=X(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(t&&(this.studyConfig=t,this.pairOrder=R(this.definition),this.applyConfiguredSupport(),t.collection.mode==="qualtrics")){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}he(t)}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get definition(){return L(this.studyConfig?.instrumentId??x)}get dimensions(){return this.definition.items}get pairs(){return _(this.definition)}get ratingValues(){return ee(this.definition)}get smileyLandmarks(){return this.definition.landmarks??[]}get dimensionById(){return new Map(this.dimensions.map(e=>[e.id,e]))}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return n`
    ...
    `}renderGazeSetup(){if(!this.gazeInputAvailable)return c;const e=F(window.location),t=this.gazeState==="loading"||this.gazeState==="positioning"||this.gazeState==="calibrating"||this.gazeState==="ready";return n`
