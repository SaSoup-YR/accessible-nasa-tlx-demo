    ...
    `}renderFullRatingScale(e,t){return r`
      <fieldset class="rating-fieldset">
        ...
        <div class="rating-grid">
          ${k.map(s=>{const i=`rating-${e.id}-${s}`;return r`
              <label
                class="rating-option"
                for=${i}
                data-gaze-target
    ...
    `}renderSmileyResponse(e,t){return r`
      <fieldset class="smiley-response">
        ...
        <div class="smiley-grid">
          ${x.map(({value:s,cue:i})=>{const a=`smiley-${e.id}-${s}`;return r`
              <label
                class="smiley-option"
                for=${a}
                data-gaze-target
