...
- `qualtrics-question.js` belongs in that question's JavaScript editor. It validates
  ...
  Bridge build `0.8.7-q7` keeps the participant iframe hidden until an exact-origin
...
- `embedded-data-fields.txt` lists the 62 fields to declare near the start of Survey
