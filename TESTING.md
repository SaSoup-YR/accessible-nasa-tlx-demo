...
3. Choose starting support and whether the participant may adjust it.
...
3. Enter a synthetic code such as `TEST-001`; do not enter a name or email address.
4. Complete six ratings and fifteen comparisons.
5. Review, correct and deliberately submit.
6. Confirm that the completion page says the record is local and offers JSON/CSV backup files.
7. If the score-display option was off, confirm that the participant page does not show the weighted score.
