...
| R19 | A Version 0.7 Qualtrics survey is reused with a Version 0.8 participant link | Migration guide requires replacement of all four integration inputs; Version 4/`AQP_*` records fail closed against old setup | Migration documentation and schema checks | Create a new/copy UCL survey and archive its exact configuration |
